...
proc create_root_design { parentCell } {
  ...
  set resonator_dds_0 [ create_bd_cell -type ip -vlnv MazinLab:mkidgen3:resonator_dds:0.6 resonator_dds_0 ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets resonator_dds_0_res_out] [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_net -net event_group_misalign [get_bd_pins resonator_dds_0/event_group_misalign] [get_bd_pins system_ila_0/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets event_group_misalign]
  ...
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs resonator_dds_0/s_axi_control/Reg] -force
