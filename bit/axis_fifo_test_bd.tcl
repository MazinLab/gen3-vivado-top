...
################################################################
# This is a generated script based on design: axis_fifo_test
#
...
# source axis_fifo_test_script.tcl
...
set design_name axis_fifo_test
...
connect_bd_intf_net -intf_net [get_bd_intf_nets S00_AXIS_1] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M01_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tready] [get_bd_pins axis_interconnect_0/S00_AXIS_tready] [get_bd_pins system_ila_0/SLOT_1_AXIS_tready]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins axi_dma_0/s2mm_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tdata [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tdata] [get_bd_pins axis_interconnect_0/S00_AXIS_tdata] [get_bd_pins system_ila_0/SLOT_1_AXIS_tdata]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tdest [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tdest] [get_bd_pins axis_interconnect_0/S00_AXIS_tdest] [get_bd_pins system_ila_0/SLOT_1_AXIS_tdest]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tkeep [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tkeep] [get_bd_pins axis_interconnect_0/S00_AXIS_tkeep] [get_bd_pins system_ila_0/SLOT_1_AXIS_tkeep]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tlast [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tlast] [get_bd_pins axis_interconnect_0/S00_AXIS_tlast] [get_bd_pins system_ila_0/SLOT_1_AXIS_tlast]
  connect_bd_net -net axi_fifo_mm_s_0_axi_str_txd_tvalid [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tvalid] [get_bd_pins axis_interconnect_0/S00_AXIS_tvalid] [get_bd_pins system_ila_0/SLOT_1_AXIS_tvalid]
  connect_bd_net -net axi_fifo_mm_s_0_interrupt [get_bd_pins axi_fifo_mm_s_0/interrupt] [get_bd_pins system_ila_0/probe0] [get_bd_pins xlconcat_0/In1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets axi_fifo_mm_s_0_interrupt]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net mm2s_prmry_reset_out_n [get_bd_pins axi_fifo_mm_s_0/mm2s_prmry_reset_out_n] [get_bd_pins axis_interconnect_0/S00_AXIS_ARESETN] [get_bd_pins system_ila_0/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets mm2s_prmry_reset_out_n]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_interconnect_0/ARESETN] [get_bd_pins axis_interconnect_0/M00_AXIS_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_interconnect_0/ACLK] [get_bd_pins axis_interconnect_0/M00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S00_AXIS_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
