...
################################################################
# This is a generated script based on design: test_dwidth
#
...
proc create_hier_cell_phasematch { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_DOUT
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_CARTESIAN2

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_CARTESIAN3
  ...
  create_bd_pin -dir O -type intr event_s_data_tlast_missing
  create_bd_pin -dir O -type intr event_s_data_tlast_unexpected
  ...
  set_property -dict [ list \
   CONFIG.CoefficientVector {1,0,0,0} \
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S_AXIS_DATA] [get_bd_intf_pins fir_compiler_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net arctan_phase1_M_AXIS_DOUT [get_bd_intf_pins arctan_phase1/M_AXIS_DOUT] [get_bd_intf_pins axis_combiner_0/S01_AXIS]
  connect_bd_intf_net -intf_net [get_bd_intf_nets arctan_phase1_M_AXIS_DOUT] [get_bd_intf_pins S01_AXIS] [get_bd_intf_pins arctan_phase1/M_AXIS_DOUT]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets arctan_phase1_M_AXIS_DOUT]
  connect_bd_intf_net -intf_net arctan_phase2_M_AXIS_DOUT [get_bd_intf_pins arctan_phase2/M_AXIS_DOUT] [get_bd_intf_pins axis_combiner_0/S02_AXIS]
  connect_bd_intf_net -intf_net arctan_phase3_M_AXIS_DOUT [get_bd_intf_pins arctan_phase3/M_AXIS_DOUT] [get_bd_intf_pins axis_combiner_0/S03_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_broadcaster_0_M02_AXIS] [get_bd_intf_pins S_AXIS_CARTESIAN2] [get_bd_intf_pins axis_broadcaster_0/M02_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_broadcaster_0_M03_AXIS] [get_bd_intf_pins S_AXIS_CARTESIAN3] [get_bd_intf_pins axis_broadcaster_0/M03_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_broadcaster_0_M03_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_0_M_AXIS] [get_bd_intf_pins M_AXIS1] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_dwidth_converter_0_M_AXIS1] [get_bd_intf_pins S_AXIS1] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_dwidth_converter_0_M_AXIS1]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets fir_compiler_0_M_AXIS_DATA] [get_bd_intf_pins S_AXIS] [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets fir_compiler_0_M_AXIS_DATA]
  connect_bd_intf_net -intf_net matched_filter_512x0_M_AXIS_DATA [get_bd_intf_pins arctan_phase/M_AXIS_DOUT] [get_bd_intf_pins axis_combiner_0/S00_AXIS]
  connect_bd_intf_net -intf_net [get_bd_intf_nets matched_filter_512x0_M_AXIS_DATA] [get_bd_intf_pins M_AXIS_DOUT] [get_bd_intf_pins arctan_phase/M_AXIS_DOUT]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets matched_filter_512x0_M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins arctan_phase/aclk] [get_bd_pins arctan_phase1/aclk] [get_bd_pins arctan_phase2/aclk] [get_bd_pins arctan_phase3/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins fir_compiler_0/aclk]
  connect_bd_net -net Net1 [get_bd_pins aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins phasematch/S01_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins phasematch/S_AXIS_CARTESIAN] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins phasematch/S_AXIS_CARTESIAN1] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins phasematch/S_AXIS_CARTESIAN2] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins phasematch/S_AXIS_CARTESIAN3] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins phasematch/M_AXIS1] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins phasematch/M_AXIS_DOUT] [get_bd_intf_pins system_ila_0/SLOT_7_AXIS]
connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins phasematch/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_8_AXIS]
connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins phasematch/S_AXIS1] [get_bd_intf_pins system_ila_0/SLOT_9_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins phasematch/S_AXIS_DATA]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets reschan_M_AXIS_DATA_0] [get_bd_intf_pins phasematch/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_6_AXIS]
  ...
  connect_bd_net -net phasematch_event_s_data_tlast_missing [get_bd_pins phasematch/event_s_data_tlast_missing] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net phasematch_event_s_data_tlast_unexpected [get_bd_pins phasematch/event_s_data_tlast_unexpected] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins phasematch/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
