...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  set bin_to_res_0 [ create_bd_cell -type ip -vlnv MazinLab:mkidgen3:bin_to_res:0.6 bin_to_res_0 ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXIS_DATA_0] [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets gen3_opfb_100MHz_0_M_AXIS_IQBINS] [get_bd_intf_pins reschan/iq_stream] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  ...
  connect_bd_intf_net -intf_net reschan_M_AXIS_DATA_0 [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins reschan/M_AXIS_DATA_0]
connect_bd_intf_net -intf_net [get_bd_intf_nets reschan_M_AXIS_DATA_0] [get_bd_intf_pins reschan/M_AXIS_DATA_0] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
