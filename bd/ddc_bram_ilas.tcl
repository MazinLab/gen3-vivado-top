...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axi_bram_ctrl_0_BRAM_PORTA] [get_bd_intf_pins BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets resonator_ddc_contro_0_tones_and_centers_PORTA] [get_bd_intf_pins BRAM_PORTB] [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets resonator_ddc_contro_0_tones_and_centers_PORTA]
  ...
  connect_bd_net -net resonator_ddc_contro_0_tones_and_centers_Addr_A [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins resonator_ddc_contro_0/tones_and_centers_Addr_A]
...
proc create_hier_cell_photon_pipe { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins BRAM_PORTA] [get_bd_intf_pins reschan/BRAM_PORTA]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins BRAM_PORTB] [get_bd_intf_pins reschan/BRAM_PORTB]
...
\
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins photon_pipe/BRAM_PORTA] [get_bd_intf_pins system_ila_0/SLOT_0_BRAM]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins photon_pipe/BRAM_PORTB] [get_bd_intf_pins system_ila_0/SLOT_1_BRAM]
  ...
  assign_bd_address -offset 0xA00C0000 -range 0x00004000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/reschan/axi_bram_ctrl_0/S_AXI/Mem0] -force
