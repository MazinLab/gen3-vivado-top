...
# module references:
# axis2mm, axis2mm, axis2mm, axis2mm, axis2mm, axis2mm, axis2mm, axis2mm, axis2mm, axis2mm
...
mazinlab:mkidgen3:photon:0.01\
mazinlab:mkidgen3:postage:0.01\
xilinx.com:ip:smartconnect:1.0\
mazinlab:mkidgen3:trigger:0.01\
"
...
proc create_hier_cell_trigger { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 IQ512_AXIS

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 PHASE_AXIS

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S00_AXI

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 photon2width

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 photon_trig

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 photons

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 postage0

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 postage0_256

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:aximm_rtl:1.0 postage0_axi

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 postage_iq

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 postage_trig

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 trigger_axi


  # Create pins
  create_bd_pin -dir O -from 15 -to 0 -type data Q
  ...
  if { [catch {set axis2mm_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.LGFIFO {6} \
   CONFIG.LGLEN {27} \
   CONFIG.OPT_TLAST_SYNC {1} \
 ] $axis2mm_0

  # Create instance: axis2mm_1, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_1
  if { [catch {set axis2mm_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: axis2mm_2, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_2
  if { [catch {set axis2mm_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: axis2mm_3, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_3
  if { [catch {set axis2mm_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_3 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: axis2mm_4, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_4
  if { [catch {set axis2mm_4 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_4 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: axis2mm_5, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_5
  if { [catch {set axis2mm_5 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_5 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: axis2mm_6, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_6
  if { [catch {set axis2mm_6 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_6 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: axis2mm_7, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_7
  if { [catch {set axis2mm_7 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_7 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: axis2mm_8, and set properties
  set block_name axis2mm
  set block_cell_name axis2mm_8
  if { [catch {set axis2mm_8 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis2mm_8 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  # Create instance: photon_0, and set properties
  set photon_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:photon:0.01 photon_0 ]

  # Create instance: postage_0, and set properties
  set postage_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:postage:0.01 postage_0 ]
  ...
  set trigger_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:trigger:0.01 trigger_0 ]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins trigger_axi] [get_bd_intf_pins smartconnect_0/M00_AXI]
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins IQ512_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins axis2mm_1/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins axis2mm_2/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins axis2mm_3/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins axis2mm_4/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins axis2mm_5/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins axis2mm_6/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M07_AXI [get_bd_intf_pins axi_interconnect_0/M07_AXI] [get_bd_intf_pins axis2mm_7/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins axis2mm_8/S_AXIL]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins trigger_0/s_axi_control]
  connect_bd_intf_net -intf_net axi_interconnect_1_M02_AXI [get_bd_intf_pins axi_interconnect_1/M02_AXI] [get_bd_intf_pins postage_0/s_axi_control]
  connect_bd_intf_net -intf_net axis2mm_0_M_AXI [get_bd_intf_pins axis2mm_0/M_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis2mm_0_M_AXI] [get_bd_intf_pins postage0_axi] [get_bd_intf_pins axis2mm_0/M_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis2mm_0_M_AXI]
  connect_bd_intf_net -intf_net axis2mm_1_M_AXI [get_bd_intf_pins axis2mm_1/M_AXI] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net axis2mm_2_M_AXI [get_bd_intf_pins axis2mm_2/M_AXI] [get_bd_intf_pins smartconnect_0/S02_AXI]
  connect_bd_intf_net -intf_net axis2mm_3_M_AXI [get_bd_intf_pins axis2mm_3/M_AXI] [get_bd_intf_pins smartconnect_0/S03_AXI]
  connect_bd_intf_net -intf_net axis2mm_4_M_AXI [get_bd_intf_pins axis2mm_4/M_AXI] [get_bd_intf_pins smartconnect_0/S04_AXI]
  connect_bd_intf_net -intf_net axis2mm_5_M_AXI [get_bd_intf_pins axis2mm_5/M_AXI] [get_bd_intf_pins smartconnect_0/S05_AXI]
  connect_bd_intf_net -intf_net axis2mm_6_M_AXI [get_bd_intf_pins axis2mm_6/M_AXI] [get_bd_intf_pins smartconnect_0/S06_AXI]
  connect_bd_intf_net -intf_net axis2mm_7_M_AXI [get_bd_intf_pins axis2mm_7/M_AXI] [get_bd_intf_pins smartconnect_0/S07_AXI]
  connect_bd_intf_net -intf_net axis2mm_8_M_AXI [get_bd_intf_pins axis2mm_8/M_AXI] [get_bd_intf_pins smartconnect_0/S08_AXI]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_clock_converter_0_M_AXIS] [get_bd_intf_pins postage0_256] [get_bd_intf_pins axis_clock_converter_0/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_clock_converter_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_1_M_AXIS [get_bd_intf_pins axis2mm_1/S_AXIS] [get_bd_intf_pins axis_clock_converter_1/M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_2_M_AXIS [get_bd_intf_pins axis2mm_2/S_AXIS] [get_bd_intf_pins axis_clock_converter_2/M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_3_M_AXIS [get_bd_intf_pins axis2mm_3/S_AXIS] [get_bd_intf_pins axis_clock_converter_3/M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_4_M_AXIS [get_bd_intf_pins axis2mm_4/S_AXIS] [get_bd_intf_pins axis_clock_converter_4/M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_5_M_AXIS [get_bd_intf_pins axis2mm_5/S_AXIS] [get_bd_intf_pins axis_clock_converter_5/M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_6_M_AXIS [get_bd_intf_pins axis2mm_6/S_AXIS] [get_bd_intf_pins axis_clock_converter_6/M_AXIS]
  connect_bd_intf_net -intf_net axis_clock_converter_7_M_AXIS [get_bd_intf_pins axis2mm_7/S_AXIS] [get_bd_intf_pins axis_clock_converter_7/M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins postage_0/iniq]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins postage_iq] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_1_M_AXIS] [get_bd_intf_pins photon2width] [get_bd_intf_pins axis_data_fifo_1/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_data_fifo_1_M_AXIS]
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis2mm_8/S_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins photon_0/instream]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_register_slice_0_M_AXIS] [get_bd_intf_pins photon_trig] [get_bd_intf_pins axis_register_slice_0/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_register_slice_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_1_M_AXIS [get_bd_intf_pins axis_register_slice_1/M_AXIS] [get_bd_intf_pins postage_0/instream]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_register_slice_1_M_AXIS] [get_bd_intf_pins postage_trig] [get_bd_intf_pins axis_register_slice_1/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_register_slice_1_M_AXIS]
  connect_bd_intf_net -intf_net instream_1 [get_bd_intf_pins PHASE_AXIS] [get_bd_intf_pins trigger_0/instream]
  connect_bd_intf_net -intf_net photon_0_photons_V [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins photon_0/photons_V]
  connect_bd_intf_net -intf_net [get_bd_intf_nets photon_0_photons_V] [get_bd_intf_pins photons] [get_bd_intf_pins axis_data_fifo_1/S_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets photon_0_photons_V]
  connect_bd_intf_net -intf_net postage_0_iq_out_0 [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins postage_0/iq_out_0]
  connect_bd_intf_net -intf_net [get_bd_intf_nets postage_0_iq_out_0] [get_bd_intf_pins postage0] [get_bd_intf_pins axis_clock_converter_0/S_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets postage_0_iq_out_0]
  connect_bd_intf_net -intf_net postage_0_iq_out_1 [get_bd_intf_pins axis_clock_converter_1/S_AXIS] [get_bd_intf_pins postage_0/iq_out_1]
  connect_bd_intf_net -intf_net postage_0_iq_out_2 [get_bd_intf_pins axis_clock_converter_2/S_AXIS] [get_bd_intf_pins postage_0/iq_out_2]
  connect_bd_intf_net -intf_net postage_0_iq_out_3 [get_bd_intf_pins axis_clock_converter_3/S_AXIS] [get_bd_intf_pins postage_0/iq_out_3]
  connect_bd_intf_net -intf_net postage_0_iq_out_4 [get_bd_intf_pins axis_clock_converter_4/S_AXIS] [get_bd_intf_pins postage_0/iq_out_4]
  connect_bd_intf_net -intf_net postage_0_iq_out_5 [get_bd_intf_pins axis_clock_converter_5/S_AXIS] [get_bd_intf_pins postage_0/iq_out_5]
  connect_bd_intf_net -intf_net postage_0_iq_out_6 [get_bd_intf_pins axis_clock_converter_6/S_AXIS] [get_bd_intf_pins postage_0/iq_out_6]
  connect_bd_intf_net -intf_net postage_0_iq_out_7 [get_bd_intf_pins axis_clock_converter_7/S_AXIS] [get_bd_intf_pins postage_0/iq_out_7]
  connect_bd_intf_net -intf_net trigger_0_outstream [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins trigger_0/outstream]

  # Create port connections
  connect_bd_net -net M00_ACLK_2 [get_bd_pins aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axis2mm_0/S_AXI_ACLK] [get_bd_pins axis2mm_1/S_AXI_ACLK] [get_bd_pins axis2mm_2/S_AXI_ACLK] [get_bd_pins axis2mm_3/S_AXI_ACLK] [get_bd_pins axis2mm_4/S_AXI_ACLK] [get_bd_pins axis2mm_5/S_AXI_ACLK] [get_bd_pins axis2mm_6/S_AXI_ACLK] [get_bd_pins axis2mm_7/S_AXI_ACLK] [get_bd_pins axis2mm_8/S_AXI_ACLK] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_clock_converter_1/m_axis_aclk] [get_bd_pins axis_clock_converter_2/m_axis_aclk] [get_bd_pins axis_clock_converter_3/m_axis_aclk] [get_bd_pins axis_clock_converter_4/m_axis_aclk] [get_bd_pins axis_clock_converter_5/m_axis_aclk] [get_bd_pins axis_clock_converter_6/m_axis_aclk] [get_bd_pins axis_clock_converter_7/m_axis_aclk] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net M01_ACLK_1 [get_bd_pins pipe_aclk] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_clock_converter_1/s_axis_aclk] [get_bd_pins axis_clock_converter_2/s_axis_aclk] [get_bd_pins axis_clock_converter_3/s_axis_aclk] [get_bd_pins axis_clock_converter_4/s_axis_aclk] [get_bd_pins axis_clock_converter_5/s_axis_aclk] [get_bd_pins axis_clock_converter_6/s_axis_aclk] [get_bd_pins axis_clock_converter_7/s_axis_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins photon_0/ap_clk] [get_bd_pins postage_0/ap_clk] [get_bd_pins trigger_0/ap_clk]
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins ap_rst_n] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_clock_converter_1/s_axis_aresetn] [get_bd_pins axis_clock_converter_2/s_axis_aresetn] [get_bd_pins axis_clock_converter_3/s_axis_aresetn] [get_bd_pins axis_clock_converter_4/s_axis_aresetn] [get_bd_pins axis_clock_converter_5/s_axis_aresetn] [get_bd_pins axis_clock_converter_6/s_axis_aresetn] [get_bd_pins axis_clock_converter_7/s_axis_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins photon_0/ap_rst_n] [get_bd_pins postage_0/ap_rst_n] [get_bd_pins trigger_0/ap_rst_n]
  connect_bd_net -net M08_ARESETN_1 [get_bd_pins m_axis_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_interconnect_0/M06_ARESETN] [get_bd_pins axi_interconnect_0/M07_ARESETN] [get_bd_pins axi_interconnect_0/M08_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axis2mm_0/S_AXI_ARESETN] [get_bd_pins axis2mm_1/S_AXI_ARESETN] [get_bd_pins axis2mm_2/S_AXI_ARESETN] [get_bd_pins axis2mm_3/S_AXI_ARESETN] [get_bd_pins axis2mm_4/S_AXI_ARESETN] [get_bd_pins axis2mm_5/S_AXI_ARESETN] [get_bd_pins axis2mm_6/S_AXI_ARESETN] [get_bd_pins axis2mm_7/S_AXI_ARESETN] [get_bd_pins axis2mm_8/S_AXI_ARESETN] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_clock_converter_1/m_axis_aresetn] [get_bd_pins axis_clock_converter_2/m_axis_aresetn] [get_bd_pins axis_clock_converter_3/m_axis_aresetn] [get_bd_pins axis_clock_converter_4/m_axis_aresetn] [get_bd_pins axis_clock_converter_5/m_axis_aresetn] [get_bd_pins axis_clock_converter_6/m_axis_aresetn] [get_bd_pins axis_clock_converter_7/m_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
  connect_bd_net -net axis2mm_0_o_int [get_bd_pins axis2mm_0/o_int] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axis2mm_1_o_int [get_bd_pins axis2mm_1/o_int] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axis2mm_2_o_int [get_bd_pins axis2mm_2/o_int] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axis2mm_3_o_int [get_bd_pins axis2mm_3/o_int] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axis2mm_4_o_int [get_bd_pins axis2mm_4/o_int] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net axis2mm_5_o_int [get_bd_pins axis2mm_5/o_int] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net axis2mm_6_o_int [get_bd_pins axis2mm_6/o_int] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net axis2mm_7_o_int [get_bd_pins axis2mm_7/o_int] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net axis2mm_8_o_int [get_bd_pins axis2mm_8/o_int] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net axis_register_slice_0_m_axis_tvalid [get_bd_pins m_axis_tvalid] [get_bd_pins axis_register_slice_0/m_axis_tvalid] [get_bd_pins c_counter_binary_0/CE] [get_bd_pins photon_0/instream_TVALID]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins Q] [get_bd_pins c_counter_binary_0/Q] [get_bd_pins photon_0/timestamps_V_TDATA]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins photon_0/timestamps_V_TVALID] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_phase { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS_IQ512
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 cordic0_out
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M_AXIS_IQ512] [get_bd_intf_pins axis_broadcaster_1/M01_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins axis_broadcaster_1/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_dwidth_converter_0_M_AXIS [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins axis_dwidth_converter_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins cordic_0/S_AXIS_CARTESIAN]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_register_slice_0_M_AXIS] [get_bd_intf_pins M_AXIS] [get_bd_intf_pins axis_register_slice_0/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_register_slice_0_M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_1_M_AXIS [get_bd_intf_pins axis_register_slice_1/M_AXIS] [get_bd_intf_pins cordic_1/S_AXIS_CARTESIAN]
  connect_bd_intf_net -intf_net axis_register_slice_2_M_AXIS [get_bd_intf_pins axis_register_slice_2/M_AXIS] [get_bd_intf_pins cordic_2/S_AXIS_CARTESIAN]
  connect_bd_intf_net -intf_net axis_register_slice_3_M_AXIS [get_bd_intf_pins axis_register_slice_3/M_AXIS] [get_bd_intf_pins cordic_3/S_AXIS_CARTESIAN]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets cordic_0_M_AXIS_DOUT] [get_bd_intf_pins cordic0_out] [get_bd_intf_pins cordic_0/M_AXIS_DOUT]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets cordic_0_M_AXIS_DOUT]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins attach_user_0/ap_clk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins cordic_0/aclk] [get_bd_pins cordic_1/aclk] [get_bd_pins cordic_2/aclk] [get_bd_pins cordic_3/aclk]
  connect_bd_net -net Net1 [get_bd_pins attach_user_0/ap_rst_n] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_replay2opfb { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 iq_replay

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 opfb_out
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins opfb_out] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins axis_register_slice_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net dac_table_axim_0_iqout [get_bd_intf_pins iq_replay] [get_bd_intf_pins axis_register_slice_0/S_AXIS]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins pipe_aclk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins axis_data_fifo_1/m_axis_aclk] [get_bd_pins axis_data_fifo_2/m_axis_aclk] [get_bd_pins axis_dwidth_converter_1/aclk] [get_bd_pins axis_dwidth_converter_2/aclk]
  ...
  connect_bd_net -net resets_never_reset_256 [get_bd_pins replay_aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins axis_data_fifo_2/s_axis_aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins replay_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins axis_data_fifo_2/s_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_data_fifo_0/m_axis_tready] [get_bd_pins axis_dwidth_converter_1/m_axis_tready] [get_bd_pins axis_dwidth_converter_2/m_axis_tready] [get_bd_pins xlconstant_0/dout]
...
proc create_hier_cell_photon_pipe { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 PHOTON_AXI
  ...
  create_bd_pin -dir I -type rst m_axis_aresetn
  create_bd_pin -dir O m_axis_tvalid
  create_bd_pin -dir O -from 15 -to 0 -type data timestream_data
  ...
  create_hier_cell_trigger $hier_obj trigger

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins PHOTON_AXI] [get_bd_intf_pins trigger/trigger_axi]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins iq_stream] [get_bd_intf_pins bin_to_res/iq_stream]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S00_AXI] [get_bd_intf_pins trigger/S00_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins postage0_axi] [get_bd_intf_pins trigger/postage0_axi]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins postage0_256] [get_bd_intf_pins trigger/postage0_256]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins photon2width] [get_bd_intf_pins trigger/photon2width]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins postage_iq] [get_bd_intf_pins trigger/postage_iq]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins photon_trig] [get_bd_intf_pins trigger/photon_trig]
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins postage_trig] [get_bd_intf_pins trigger/postage_trig]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins photons] [get_bd_intf_pins trigger/photons]
  connect_bd_intf_net -intf_net Conn11 [get_bd_intf_pins postage0] [get_bd_intf_pins trigger/postage0]
  connect_bd_intf_net -intf_net Conn12 [get_bd_intf_pins M_AXIS] [get_bd_intf_pins phase/M_AXIS]
  connect_bd_intf_net -intf_net Conn13 [get_bd_intf_pins cordic0_out] [get_bd_intf_pins phase/cordic0_out]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins axis_broadcaster_1/M01_AXIS] [get_bd_intf_pins axis_register_slice_5/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_3_M_AXIS [get_bd_intf_pins axis_register_slice_3/M_AXIS] [get_bd_intf_pins trigger/PHASE_AXIS]
  ...
  connect_bd_intf_net -intf_net bin2res_control_1 [get_bd_intf_pins bin2res_control] [get_bd_intf_pins bin_to_res/s_axi_control]
  connect_bd_intf_net -intf_net bin_to_res_res_stream [get_bd_intf_pins bin_to_res/res_stream] [get_bd_intf_pins fir_compiler_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net fir_compiler_0_M_AXIS_DATA [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA]
  connect_bd_intf_net -intf_net phase_M01_AXIS [get_bd_intf_pins phase/M_AXIS_IQ512] [get_bd_intf_pins trigger/IQ512_AXIS]
  ...
  # Create port connections
  connect_bd_net -net aclk_256 [get_bd_pins aclk1] [get_bd_pins trigger/aclk]
  connect_bd_net -net ap_clk_1 [get_bd_pins aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_broadcaster_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins axis_register_slice_5/aclk] [get_bd_pins bin_to_res/ap_clk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins phase/aclk] [get_bd_pins trigger/pipe_aclk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_broadcaster_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins bin_to_res/ap_rst_n] [get_bd_pins trigger/ap_rst_n]
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins m_axis_aresetn] [get_bd_pins trigger/m_axis_aresetn]
  connect_bd_net -net trigger_Q [get_bd_pins timestream_data] [get_bd_pins trigger/Q]
  connect_bd_net -net trigger_dout [get_bd_pins dout] [get_bd_pins trigger/dout]
  connect_bd_net -net trigger_m_axis_tvalid [get_bd_pins m_axis_tvalid] [get_bd_pins trigger/m_axis_tvalid]
...
proc create_hier_cell_capture { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Switchboard_M_AXIS [get_bd_intf_pins Switchboard/M_AXIS] [get_bd_intf_pins axis2mm_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axis2mm_0/S_AXIL]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins Switchboard/S_AXI_CTRL] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins filter_phase_0/s_axi_control]
  ...
  connect_bd_intf_net -intf_net filter_iq_0_outstream [get_bd_intf_pins Switchboard/S01_AXIS] [get_bd_intf_pins filter_iq_0/outstream]
  connect_bd_intf_net -intf_net filter_phase_0_outstream [get_bd_intf_pins Switchboard/S02_AXIS] [get_bd_intf_pins filter_phase_0/outstream]
  connect_bd_intf_net -intf_net iq0_1 [get_bd_intf_pins iq0] [get_bd_intf_pins filter_iq_0/instream]
  connect_bd_intf_net -intf_net pair_iq_0_out_r [get_bd_intf_pins Switchboard/S00_AXIS] [get_bd_intf_pins pair_iq_0/out_r]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins pipe_clk] [get_bd_pins Switchboard/pipe_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins filter_iq_0/ap_clk] [get_bd_pins filter_phase_0/ap_clk] [get_bd_pins pair_iq_0/ap_clk]
  connect_bd_net -net Net1 [get_bd_pins axis2mm_clk] [get_bd_pins JebConnect/m_axis_aclk] [get_bd_pins Switchboard/axis2mm_clk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axis2mm_0/S_AXI_ACLK]
  connect_bd_net -net Net2 [get_bd_pins axis2mm_aresetn] [get_bd_pins JebConnect/S_AXI_ARESETN] [get_bd_pins Switchboard/axis2mm_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axis2mm_0/S_AXI_ARESETN]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins pipe_aresetn] [get_bd_pins Switchboard/pipe_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins filter_iq_0/ap_rst_n] [get_bd_pins filter_phase_0/ap_rst_n] [get_bd_pins pair_iq_0/ap_rst_n]
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M01_AXI [get_bd_intf_pins axi_interconnect_1/M01_AXI] [get_bd_intf_pins photon_pipe/S00_AXI]
...
connect_bd_intf_net -intf_net cordic0_out [get_bd_intf_pins photon_pipe/cordic0_out] [get_bd_intf_pins system_ila_1/SLOT_5_AXIS]
  ...
  connect_bd_intf_net -intf_net dac_table_axim_0_iqout [get_bd_intf_pins dac_table_axim_0/iqout] [get_bd_intf_pins replay2opfb/iq_replay]
  ...
  connect_bd_intf_net -intf_net phase_axis [get_bd_intf_pins capture/phase0] [get_bd_intf_pins photon_pipe/PHASE_AXIS]
connect_bd_intf_net -intf_net photon2width [get_bd_intf_pins photon_pipe/photon2width] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net photon_trig [get_bd_intf_pins photon_pipe/photon_trig] [get_bd_intf_pins system_ila_1/SLOT_1_AXIS]
connect_bd_intf_net -intf_net photons [get_bd_intf_pins photon_pipe/photons] [get_bd_intf_pins system_ila_1/SLOT_3_AXIS]
connect_bd_intf_net -intf_net postage0 [get_bd_intf_pins photon_pipe/postage0] [get_bd_intf_pins system_ila_1/SLOT_4_AXIS]
connect_bd_intf_net -intf_net postage0_256 [get_bd_intf_pins photon_pipe/postage0_256] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net postage0_axi [get_bd_intf_pins photon_pipe/postage0_axi] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
connect_bd_intf_net -intf_net postage_iq [get_bd_intf_pins photon_pipe/postage_iq] [get_bd_intf_pins system_ila_1/SLOT_0_AXIS]
connect_bd_intf_net -intf_net postage_trig [get_bd_intf_pins photon_pipe/postage_trig] [get_bd_intf_pins system_ila_1/SLOT_2_AXIS]
  ...
  connect_bd_intf_net -intf_net rawiq_axis [get_bd_intf_pins capture/iq0] [get_bd_intf_pins photon_pipe/RAWIQ_AXIS]
  ...
  connect_bd_intf_net -intf_net replay2opfb_opfb_out [get_bd_intf_pins photon_pipe/iq_stream] [get_bd_intf_pins replay2opfb/opfb_out]
  ...
  connect_bd_intf_net -intf_net trigger_axi [get_bd_intf_pins photon_pipe/PHOTON_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets trigger_axi] [get_bd_intf_pins photon_pipe/PHOTON_AXI] [get_bd_intf_pins system_ila_0/SLOT_3_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins capture/pipe_clk] [get_bd_pins photon_pipe/aclk] [get_bd_pins replay2opfb/pipe_aclk] [get_bd_pins resets/slowest_sync_clk] [get_bd_pins rfdc/clk_out1] [get_bd_pins system_ila_1/clk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins capture/axis2mm_clk] [get_bd_pins photon_pipe/aclk1] [get_bd_pins resets/slowest_sync_clk3] [get_bd_pins rfdc/clk_out2] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net dcm_locked_1 [get_bd_pins resets/dcm_locked] [get_bd_pins rfdc/locked]
  connect_bd_net -net photon_pipe_dout [get_bd_pins photon_pipe/dout] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net photon_pipe_m_axis_tvalid [get_bd_pins photon_pipe/m_axis_tvalid] [get_bd_pins system_ila_1/SLOT_1_AXIS_tvalid]
  connect_bd_net -net resets_never_reset [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins capture/pipe_aresetn] [get_bd_pins photon_pipe/ap_rst_n] [get_bd_pins replay2opfb/pipe_aresetn] [get_bd_pins resets/never_reset_512] [get_bd_pins system_ila_1/resetn]
  connect_bd_net -net resets_never_reset_256 -boundary_type upper [get_bd_pins resets/never_reset_256]
  connect_bd_net -net resets_never_reset_512_256 [get_bd_pins capture/axis2mm_aresetn] [get_bd_pins photon_pipe/m_axis_aresetn] [get_bd_pins resets/never_reset_512_256] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net timestream [get_bd_pins photon_pipe/timestream_data] [get_bd_pins system_ila_1/probe0]
  ...
  assign_bd_address -offset 0xA00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_0/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA00E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_1/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA00F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_2/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA0100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_3/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_4/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA0120000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_5/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA0130000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_6/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA0140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_7/S_AXIL/reg0] -force
  assign_bd_address -offset 0xA0150000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/axis2mm_8/S_AXIL/reg0] -force
  ...
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/bin_to_res/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0xA0160000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/postage_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0170000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/trigger/trigger_0/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_2/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_2/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_2/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_2/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_3/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_3/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_3/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_3/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_4/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_4/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_4/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_4/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_5/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_5/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_5/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_5/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_6/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_6/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_6/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_6/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_7/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_7/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_7/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_7/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_8/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_8/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_8/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces photon_pipe/trigger/axis2mm_8/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
