...
################################################################
# This is a generated script based on design: test_phasematch
#
...
# source test_phasematch_script.tcl
...
set design_name test_phasematch
...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net bin_to_res_0_res_stream [get_bd_intf_pins iq_stream] [get_bd_intf_pins resonator_dds_0/res_in]
  ...
  connect_bd_net -net S_AXI_clk_0_1 [get_bd_pins S_AXI_clk] [get_bd_pins resonator_dds_0/s_axi_clk]
  connect_bd_net -net ap_clk_0_1 [get_bd_pins ap_clk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins resonator_dds_0/ap_clk]
  connect_bd_net -net ap_rst_n_0_1 [get_bd_pins ap_rst_n] [get_bd_pins resonator_dds_0/ap_rst_n]
  connect_bd_net -net ap_rst_n_S_AXI_clk_1 [get_bd_pins ap_rst_n_S_AXI_clk] [get_bd_pins resonator_dds_0/ap_rst_n_s_axi_clk]
...
proc create_hier_cell_phasematch { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_msg_id "BD_TCL-102" "ERROR" "create_hier_cell_phasematch() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 AXI_STR_TXD
  ...
  set_property -dict [ list \
   ...
   CONFIG.Clock_Frequency {300.0} \
   CONFIG.CoefficientSource {COE_File} \
   CONFIG.Coefficient_File {../../../../../../../data/30-tap-256-rid-opt-match.coe} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins M_AXIS] [get_bd_intf_pins axis_combiner_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins S_AXI1] [get_bd_intf_pins axi_fifo_mm_s_1/S_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S_AXI_CTRL] [get_bd_intf_pins axis_switch_0/S_AXI_CTRL]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets arctan_phase_M_AXIS_DOUT] [get_bd_intf_pins S_AXIS_DATA] [get_bd_intf_pins arctan_phase/M_AXIS_DOUT]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets arctan_phase_M_AXIS_DOUT]
  connect_bd_intf_net -intf_net axi_fifo_mm_s_0_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD] [get_bd_intf_pins axis_broadcaster_1/S_AXIS]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axi_fifo_mm_s_0_AXI_STR_TXD] [get_bd_intf_pins AXI_STR_TXD] [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_fifo_mm_s_0_AXI_STR_TXD]
  connect_bd_intf_net -intf_net axi_fifo_mm_s_1_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_1/AXI_STR_TXD] [get_bd_intf_pins axis_subset_converter_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_broadcaster_0_M00_AXIS] [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins axis_broadcaster_1/M00_AXIS] [get_bd_intf_pins matched_filter_512x0/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins axis_broadcaster_1/M01_AXIS] [get_bd_intf_pins matched_filter_512x1/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M02_AXIS [get_bd_intf_pins axis_broadcaster_1/M02_AXIS] [get_bd_intf_pins matched_filter_512x2/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M03_AXIS [get_bd_intf_pins axis_broadcaster_1/M03_AXIS] [get_bd_intf_pins matched_filter_512x3/S_AXIS_CONFIG]
  ...
  connect_bd_intf_net -intf_net axis_switch_0_M00_AXIS [get_bd_intf_pins axis_switch_0/M00_AXIS] [get_bd_intf_pins matched_filter_512x0/S_AXIS_RELOAD]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_switch_0_M00_AXIS] [get_bd_intf_pins M00_AXIS1] [get_bd_intf_pins axis_switch_0/M00_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_switch_0_M00_AXIS]
  connect_bd_intf_net -intf_net axis_switch_0_M01_AXIS [get_bd_intf_pins axis_switch_0/M01_AXIS] [get_bd_intf_pins matched_filter_512x1/S_AXIS_RELOAD]
  connect_bd_intf_net -intf_net axis_switch_0_M02_AXIS [get_bd_intf_pins axis_switch_0/M02_AXIS] [get_bd_intf_pins matched_filter_512x2/S_AXIS_RELOAD]
  connect_bd_intf_net -intf_net axis_switch_0_M03_AXIS [get_bd_intf_pins axis_switch_0/M03_AXIS] [get_bd_intf_pins matched_filter_512x3/S_AXIS_RELOAD]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets matched_filter_512x0_M_AXIS_DATA] [get_bd_intf_pins M_AXIS_DATA] [get_bd_intf_pins matched_filter_512x0/M_AXIS_DATA]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets matched_filter_512x0_M_AXIS_DATA]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins arctan_phase/aclk] [get_bd_pins arctan_phase1/aclk] [get_bd_pins arctan_phase2/aclk] [get_bd_pins arctan_phase3/aclk] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_1/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_dwidth_converter_0/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_switch_0/aclk] [get_bd_pins axis_switch_0/s_axi_ctrl_aclk] [get_bd_pins matched_filter_512x0/aclk] [get_bd_pins matched_filter_512x1/aclk] [get_bd_pins matched_filter_512x2/aclk] [get_bd_pins matched_filter_512x3/aclk]
  connect_bd_net -net Net1 [get_bd_pins aresetn] [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_1/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_switch_0/s_axi_ctrl_aresetn]
  connect_bd_net -net axi_fifo_mm_s_0_interrupt [get_bd_pins axi_fifo_mm_s_0/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_fifo_mm_s_0_mm2s_prmry_reset_out_n [get_bd_pins axi_fifo_mm_s_0/mm2s_prmry_reset_out_n] [get_bd_pins axis_broadcaster_1/aresetn]
  connect_bd_net -net axi_fifo_mm_s_1_interrupt [get_bd_pins axi_fifo_mm_s_1/interrupt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_fifo_mm_s_1_mm2s_prmry_reset_out_n [get_bd_pins axi_fifo_mm_s_1/mm2s_prmry_reset_out_n] [get_bd_pins axis_switch_0/aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins phasematch/S_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins phasematch/AXI_STR_TXD] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins phasematch/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins phasematch/M00_AXIS1] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins phasematch/M_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_6_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins reschan/iq_stream]
connect_bd_intf_net -intf_net [get_bd_intf_nets axis_data_fifo_0_M_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins reschan/s_axi_resonator_dds]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins phasematch/S_AXI1] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins phasematch/S_AXI_CTRL] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net reschan_M_AXIS_DATA [get_bd_intf_pins phasematch/S_AXIS] [get_bd_intf_pins reschan/M_AXIS_DATA]
connect_bd_intf_net -intf_net [get_bd_intf_nets reschan_M_AXIS_DATA] [get_bd_intf_pins reschan/M_AXIS_DATA] [get_bd_intf_pins system_ila_0/SLOT_7_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets reschan_M_AXIS_DATA]
  connect_bd_intf_net -intf_net reschan_M_AXIS_DATA_0 [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins phasematch/M_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets reschan_M_AXIS_DATA_0] [get_bd_intf_pins phasematch/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_5_AXIS]
  ...
  connect_bd_net -net phasematch_dout [get_bd_pins phasematch/dout] [get_bd_pins system_ila_0/probe0] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins phasematch/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins reschan/ap_rst_n] [get_bd_pins reschan/ap_rst_n_S_AXI_clk] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins phasematch/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins reschan/S_AXI_clk] [get_bd_pins reschan/ap_clk] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs phasematch/axi_fifo_mm_s_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs phasematch/axi_fifo_mm_s_1/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs phasematch/axis_switch_0/S_AXI_CTRL/Reg] -force
