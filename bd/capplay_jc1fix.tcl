...
################################################################
# This is a generated script based on design: capplay_jc1fix
#
...
# source capplay_jc1fix_script.tcl
...
set design_name capplay_jc1fix
...
mazinlab:mkidgen3:filter_iq:0.1\
mazinlab:mkidgen3:iq_gen:0.4\
...
proc create_hier_cell_JebConnect { parentCell nameHier } {
  ...
  create_bd_pin -dir O m_axi_wvalid1
  create_bd_pin -dir O m_axi_wvalid2
  create_bd_pin -dir I -type clk m_axis_aclk
  create_bd_pin -dir O s_axi_wready1
  create_bd_pin -dir O -from 1 -to 0 s_axi_wready2
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_register_slice_1/S_AXI]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins S03_AXI] [get_bd_intf_pins axi_register_slice_2/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_dwidth_converter_1_M_AXI [get_bd_intf_pins axi_data_fifo_1/S_AXI] [get_bd_intf_pins axi_dwidth_converter_1/M_AXI]
  ...
  connect_bd_net -net Net [get_bd_pins c0_ddr4_ui_clk2] [get_bd_pins axi_crossbar_0/aclk] [get_bd_pins axi_data_fifo_0/aclk] [get_bd_pins axi_data_fifo_1/aclk] [get_bd_pins axi_data_fifo_2/aclk] [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins axi_dwidth_converter_1/m_axi_aclk] [get_bd_pins axi_register_slice_0/aclk] [get_bd_pins axi_register_slice_2/aclk]
  connect_bd_net -net Net1 [get_bd_pins aresetn] [get_bd_pins axi_crossbar_0/aresetn] [get_bd_pins axi_data_fifo_0/aresetn] [get_bd_pins axi_data_fifo_1/aresetn] [get_bd_pins axi_data_fifo_2/aresetn] [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins axi_dwidth_converter_1/m_axi_aresetn] [get_bd_pins axi_register_slice_0/aresetn] [get_bd_pins axi_register_slice_2/aresetn]
  connect_bd_net -net S_AXI_ARESETN_1 [get_bd_pins S_AXI_ARESETN] [get_bd_pins axi_dwidth_converter_1/s_axi_aresetn] [get_bd_pins axi_register_slice_1/aresetn]
  connect_bd_net -net m_axi_wvalid [get_bd_pins m_axi_wvalid1] [get_bd_pins axi_data_fifo_1/s_axi_wvalid] [get_bd_pins axi_dwidth_converter_1/m_axi_wvalid]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets m_axi_wvalid]
  connect_bd_net -net m_axi_wvalid_1 [get_bd_pins m_axi_wvalid2] [get_bd_pins axi_crossbar_0/s_axi_wvalid] [get_bd_pins axi_data_fifo_1/m_axi_wvalid]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets m_axi_wvalid_1]
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins m_axis_aclk] [get_bd_pins axi_dwidth_converter_1/s_axi_aclk] [get_bd_pins axi_register_slice_1/aclk]
  connect_bd_net -net s_axi_wready [get_bd_pins s_axi_wready1] [get_bd_pins axi_data_fifo_1/s_axi_wready] [get_bd_pins axi_dwidth_converter_1/m_axi_wready]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s_axi_wready]
  connect_bd_net -net s_axi_wready_1 [get_bd_pins s_axi_wready2] [get_bd_pins axi_crossbar_0/s_axi_wready] [get_bd_pins axi_data_fifo_1/m_axi_wready]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets s_axi_wready_1]
...
proc create_hier_cell_resets { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 -type rst never_reset_333
  ...
  create_bd_pin -dir O -from 0 -to 0 -type rst peripheral_aresetn_333
  ...
  # Create instance: proc_sys_reset_512_256, and set properties
  set proc_sys_reset_512_256 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_512_256 ]

  # Create instance: rst_capture_333M, and set properties
  set rst_capture_333M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_capture_333M ]
  set_property -dict [ list \
  ...
  # Create port connections
  connect_bd_net -net dcm_locked_1 [get_bd_pins dcm_locked] [get_bd_pins proc_sys_reset_512_256/dcm_locked] [get_bd_pins rst_clk_wiz_0_512M/dcm_locked]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins ext_reset_in] [get_bd_pins rst_usp_rf_data_converter_0_100M/ext_reset_in]
  connect_bd_net -net proc_sys_reset_512_256_peripheral_aresetn [get_bd_pins peripheral_aresetn_512_256] [get_bd_pins proc_sys_reset_512_256/peripheral_aresetn]
  connect_bd_net -net rst_capture_333M_peripheral_aresetn [get_bd_pins peripheral_aresetn_333] [get_bd_pins rst_capture_333M/peripheral_aresetn]
  ...
  connect_bd_net -net rst_usp_rf_data_converter_0_128M_peripheral_aresetn [get_bd_pins peripheral_aresetn_100] [get_bd_pins proc_sys_reset_512_256/ext_reset_in] [get_bd_pins rst_capture_333M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_512M/ext_reset_in] [get_bd_pins rst_usp_rf_data_converter_0_100M/peripheral_aresetn] [get_bd_pins rst_usp_rf_data_converter_0_256M/ext_reset_in]
  ...
  connect_bd_net -net slowest_sync_clk3_1 [get_bd_pins slowest_sync_clk3] [get_bd_pins proc_sys_reset_512_256/slowest_sync_clk]
  connect_bd_net -net slowest_sync_clk4_1 [get_bd_pins slowest_sync_clk4] [get_bd_pins rst_capture_333M/slowest_sync_clk]
  ...
  connect_bd_net -net xlconstant_5_dout [get_bd_pins never_reset_333] [get_bd_pins xlconstant_5/dout]
...
proc create_hier_cell_capture { parentCell nameHier } {
  ...
  create_bd_pin -dir O filtered_TREADY1
  create_bd_pin -dir O m_axi_wvalid
  create_bd_pin -dir O m_axi_wvalid1
  create_bd_pin -dir O s_axi_wready
  create_bd_pin -dir O -from 1 -to 0 s_axi_wready1
  ...
  if { [catch {set axis2mm_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property -dict [ list \
   CONFIG.C_AXI_DATA_WIDTH {256} \
 ] $axis2mm_0

  set_property -dict [ list \
   CONFIG.FREQ_HZ {512000000} \
   CONFIG.CLK_DOMAIN {capplay_jc1fix_clk_wiz_0_0_clk_out1} \
 ] [get_bd_intf_pins /capture/axis2mm_0/M_AXI]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {512000000} \
   CONFIG.CLK_DOMAIN {capplay_jc1fix_clk_wiz_0_0_clk_out1} \
 ] [get_bd_intf_pins /capture/axis2mm_0/S_AXIL]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {512000000} \
   CONFIG.CLK_DOMAIN {capplay_jc1fix_clk_wiz_0_0_clk_out1} \
 ] [get_bd_intf_pins /capture/axis2mm_0/S_AXIS]
  ...
  set filter_iq_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:filter_iq:0.1 filter_iq_0 ]

  # Create instance: iq_gen_0, and set properties
  set iq_gen_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:iq_gen:0.4 iq_gen_0 ]
  ...
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins s_axi_control3] [get_bd_intf_pins iq_gen_0/s_axi_control]
  connect_bd_intf_net -intf_net S03_AXI_1 [get_bd_intf_pins S03_AXI] [get_bd_intf_pins JebConnect/S03_AXI]
  connect_bd_intf_net -intf_net S_AXIL_1 [get_bd_intf_pins S_AXIL] [get_bd_intf_pins axis2mm_0/S_AXIL]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins JebConnect/M_AXI] [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets axi_smc_M00_AXI] [get_bd_intf_pins M00_AXI] [get_bd_intf_pins ddr4_0/C0_DDR4_S_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axi_smc_M00_AXI]
  connect_bd_intf_net -intf_net axis_register_slice_2_M_AXIS [get_bd_intf_pins axis_register_slice_2/M_AXIS] [get_bd_intf_pins filter_iq_0/instream]
  connect_bd_intf_net -intf_net filter_iq_0_outstream1 [get_bd_intf_pins axis2mm_0/S_AXIS] [get_bd_intf_pins filter_iq_0/outstream]
  connect_bd_intf_net -intf_net [get_bd_intf_nets filter_iq_0_outstream1] [get_bd_intf_pins S_AXIS] [get_bd_intf_pins axis2mm_0/S_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets filter_iq_0_outstream1]
  connect_bd_intf_net -intf_net iq_gen_0_out_r [get_bd_intf_pins axis_register_slice_2/S_AXIS] [get_bd_intf_pins iq_gen_0/out_r]
  connect_bd_intf_net -intf_net s_axi_control1_1 [get_bd_intf_pins s_axi_control1] [get_bd_intf_pins filter_iq_0/s_axi_control]
  connect_bd_intf_net -intf_net write_axi256_0_m_axi_gmem [get_bd_intf_pins JebConnect/S_AXI] [get_bd_intf_pins axis2mm_0/M_AXI]
  connect_bd_intf_net -intf_net [get_bd_intf_nets write_axi256_0_m_axi_gmem] [get_bd_intf_pins S_AXI] [get_bd_intf_pins axis2mm_0/M_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets write_axi256_0_m_axi_gmem]

  # Create port connections
  connect_bd_net -net JebConnect_m_axi_wvalid1 [get_bd_pins m_axi_wvalid] [get_bd_pins JebConnect/m_axi_wvalid1]
  connect_bd_net -net JebConnect_m_axi_wvalid2 [get_bd_pins m_axi_wvalid1] [get_bd_pins JebConnect/m_axi_wvalid2]
  connect_bd_net -net JebConnect_s_axi_wready1 [get_bd_pins s_axi_wready] [get_bd_pins JebConnect/s_axi_wready1]
  connect_bd_net -net JebConnect_s_axi_wready2 [get_bd_pins s_axi_wready1] [get_bd_pins JebConnect/s_axi_wready2]
  connect_bd_net -net Net [get_bd_pins ap_clk] [get_bd_pins JebConnect/m_axis_aclk] [get_bd_pins axis2mm_0/S_AXI_ACLK] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins filter_iq_0/ap_clk] [get_bd_pins iq_gen_0/ap_clk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins JebConnect/S_AXI_ARESETN] [get_bd_pins axis2mm_0/S_AXI_ARESETN] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins filter_iq_0/ap_rst_n] [get_bd_pins iq_gen_0/ap_rst_n]
  connect_bd_net -net aresetn_1 [get_bd_pins aresetn] [get_bd_pins JebConnect/aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn]
  connect_bd_net -net axis2mm_0_S_AXIS_TREADY [get_bd_pins filtered_TREADY1] [get_bd_pins axis2mm_0/S_AXIS_TREADY]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins filter_iq_0/outstream_TREADY] [get_bd_pins xlconstant_2/dout]
...
proc create_root_design { parentCell } {
  ...
  set adc2_clk [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 -portmaps { \
   CLK_N { physical_name adc2_clk_clk_n direction I } \
   CLK_P { physical_name adc2_clk_clk_p direction I } \
   } \
  adc2_clk ]
  set_property -dict [ list \
  ...
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports adc2_clk]
  ...
  set vin2_01 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 -portmaps { \
   V_N { physical_name vin2_01_v_n direction I } \
   V_P { physical_name vin2_01_v_p direction I } \
   } \
  vin2_01 ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports vin2_01]

  set vin2_23 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_analog_io_rtl:1.0 -portmaps { \
   V_N { physical_name vin2_23_v_n direction I } \
   V_P { physical_name vin2_23_v_p direction I } \
   } \
  vin2_23 ]
  set_property HDL_ATTRIBUTE.LOCKED {TRUE} [get_bd_intf_ports vin2_23]
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1}\
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins capture/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins capture/S_AXIS] [get_bd_intf_pins system_ila_1/SLOT_0_AXIS]
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins capture/S_AXI] [get_bd_intf_pins system_ila_1/SLOT_1_AXI]
  connect_bd_intf_net -intf_net adc2_clk_1 [get_bd_intf_ports adc2_clk] [get_bd_intf_pins usp_rf_data_converter_0/adc2_clk]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins capture/s_axi_control3]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins capture/S_AXIL]
  ...
  connect_bd_intf_net -intf_net s_axi_control1_1 [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins capture/s_axi_control1]
  ...
  # Create port connections
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins resets/never_reset_100]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net capture_c0_ddr4_ui_clk2 [get_bd_pins capture/c0_ddr4_ui_clk2] [get_bd_pins resets/slowest_sync_clk4] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  connect_bd_net -net capture_filtered_TREADY1 [get_bd_pins capture/filtered_TREADY1] [get_bd_pins system_ila_1/SLOT_0_AXIS_tready]
  connect_bd_net -net capture_m_axi_wvalid [get_bd_pins capture/m_axi_wvalid] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net capture_m_axi_wvalid1 [get_bd_pins capture/m_axi_wvalid1] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net capture_s_axi_wready [get_bd_pins capture/s_axi_wready] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net capture_s_axi_wready1 [get_bd_pins capture/s_axi_wready1] [get_bd_pins system_ila_0/probe3]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins capture/ap_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins resets/slowest_sync_clk] [get_bd_pins system_ila_1/clk] [get_bd_pins usp_rf_data_converter_0/m2_axis_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins resets/slowest_sync_clk3]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins resets/dcm_locked]
  connect_bd_net -net resets_never_reset [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins capture/ap_rst_n] [get_bd_pins resets/never_reset_512] [get_bd_pins system_ila_1/resetn]
  connect_bd_net -net resets_never_reset_333 [get_bd_pins capture/aresetn] [get_bd_pins resets/never_reset_333] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net resets_peripheral_aresetn1 [get_bd_pins resets/peripheral_aresetn_512] [get_bd_pins usp_rf_data_converter_0/m2_axis_aresetn]
  connect_bd_net -net resets_peripheral_aresetn2 [get_bd_pins resets/peripheral_aresetn_256] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn]
  connect_bd_net -net resets_peripheral_aresetn_100 [get_bd_pins resets/peripheral_aresetn_100] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins resets/slowest_sync_clk1] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins usp_rf_data_converter_0/clk_adc2]
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins resets/slowest_sync_clk2] [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk]
  ...
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs capture/iq_gen_0/s_axi_control/Reg] -force
