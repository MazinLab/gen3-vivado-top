...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins bin_to_res/ap_clk] [get_bd_pins dds_ddc_center_0/ap_clk] [get_bd_pins resonator_ddc_contro_0/ap_clk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins bin_to_res/ap_rst_n] [get_bd_pins dds_ddc_center_0/ap_rst_n] [get_bd_pins resonator_ddc_contro_0/ap_rst_n]
  connect_bd_net -net axi_bram_ctrl_0_bram_addr_a [get_bd_pins axi_bram_ctrl_0/bram_addr_a] [get_bd_pins xlslice_2/Din]
  connect_bd_net -net resonator_ddc_contro_0_tones_and_centers_Addr_A [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net resonator_ddc_contro_0_tones_and_centers_Addr_A1 [get_bd_pins resonator_ddc_contro_0/tones_and_centers_Addr_A] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net tones_and_centers_Dout_A [get_bd_pins blk_mem_gen_0/doutb] [get_bd_pins resonator_ddc_contro_0/tones_and_centers_Dout_A]
...
proc create_hier_cell_photon_pipe { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net ap_clk_1 [get_bd_pins aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_5/aclk] [get_bd_pins axis_register_slice_7/aclk] [get_bd_pins opfb/ap_clk] [get_bd_pins reschan/aclk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_7/aresetn] [get_bd_pins opfb/ap_rst_n] [get_bd_pins reschan/ap_rst_n]
