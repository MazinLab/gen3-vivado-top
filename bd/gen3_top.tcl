...
# module references:
# trigger_subsystem, axis2mm, lfsr_div, lfsr_div, lfsr_div, pps_synch
...
proc create_hier_cell_rfdc { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net DisableExtraDAC2_dout  [get_bd_pins DisableExtraDAC2/dout] \
  [get_bd_pins usp_rf_data_converter_0/s10_axis_tdata]
  connect_bd_net -net DisableExtraDAC_dout  [get_bd_pins DisableExtraDAC/dout] \
  [get_bd_pins usp_rf_data_converter_0/m20_axis_tready] \
  [get_bd_pins usp_rf_data_converter_0/m22_axis_tready] \
  [get_bd_pins usp_rf_data_converter_0/s10_axis_tvalid]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_clock_converter_0, and set properties
  set axi_clock_converter_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_clock_converter:2.1 axi_clock_converter_0 ]
  set_property CONFIG.READ_WRITE_MODE {READ_ONLY} $axi_clock_converter_0
  ...
  set_property CONFIG.NUM_MI {2} $axi_periph256
...
\
  ...
  # Create instance: axis_data_fifo_0, and set properties
  set axis_data_fifo_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_0 ]
  set_property CONFIG.FIFO_DEPTH {256} $axis_data_fifo_0
  ...
  connect_bd_intf_net -intf_net photon_pipe_ALIGNEDLOIQ_AXIS [get_bd_intf_pins photon_pipe/ALIGNEDLOIQ_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins axi_clock_converter_0/S_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_LPD]
  ...
  assign_bd_address -offset 0xA0200000 -range 0x00200000 -with_name SEG_axi_bram_ctrl_0_Mem0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs dactable/axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pps_synchronization/pps_synchronizer_con_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0140000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs trigger_subsystem_0/s_axi_ctrl/reg0] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -with_name SEG_trigger_subsystem_0_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs trigger_subsystem_0/s_axi_cube/reg0] -force
