...
################################################################
# This is a generated script based on design: opfb_chan_cap_nomig
#
...
# source opfb_chan_cap_nomig_script.tcl
...
mazinlab:mkidgen3:adc_capture:0.8\
xilinx.com:ip:smartconnect:1.0\
xilinx.com:ip:axis_register_slice:1.1\
mazinlab:mkidgen3:iq_capture:0.91\
xilinx.com:ip:proc_sys_reset:5.0\
mazinlab:mkidgen3:adc_to_opfb:1.11\
mazinlab:mkidgen3:fir_to_fft:1.12\
mazinlab:mkidgen3:bin_to_res:1.1\
xilinx.com:ip:fir_compiler:7.2\
mazinlab:mkidgen3:resonator_dds:1.3\
MazinLab:mkidgen3:pkg_fft_output:0.2\
MazinLab:mkidgen3:ssrfft_16x4096_axis:1.0\
xilinx.com:ip:axis_combiner:1.1\
mazinlab:mkidgen3:opfb_fir_cfg:1.0\
"
...
proc create_hier_cell_firs { parentCell nameHier } {
  ...
  set opfb_fir_cfg_1 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:opfb_fir_cfg:1.0 opfb_fir_cfg_1 ]
...
proc create_hier_cell_fft { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins ap_rst_n] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins pkg_fft_output_0/ap_rst_n]
  connect_bd_net -net Net2 [get_bd_pins clk_out1] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins pkg_fft_output_0/ap_clk] [get_bd_pins ssrfft_16x4096_axis_0/clk]
...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  set bin_to_res [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:bin_to_res:1.1 bin_to_res ]
  ...
  set resonator_ddc [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:resonator_dds:1.3 resonator_ddc ]
...
proc create_hier_cell_opfb { parentCell nameHier } {
  ...
  set adc_to_opfb_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:adc_to_opfb:1.11 adc_to_opfb_0 ]

  # Create instance: fft
  create_hier_cell_fft $hier_obj fft

  # Create instance: fir_to_fft_1, and set properties
  set fir_to_fft_1 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:fir_to_fft:1.12 fir_to_fft_1 ]
...
proc create_hier_cell_capture { parentCell nameHier } {
  ...
  set adc_capture_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:adc_capture:0.8 adc_capture_0 ]
  ...
  set iq_capture_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:iq_capture:0.91 iq_capture_0 ]

  # Create instance: iq_capture_1, and set properties
  set iq_capture_1 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:iq_capture:0.91 iq_capture_1 ]
  ...
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins c0_ddr4_ui_clk] [get_bd_pins axi_smc/aclk1]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_M_AXI_CONTROL_DATA_WIDTH {128} \
 ] $dac_table_axim_0
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins photon_pipe/s_axi_control]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins photon_pipe/s_axi_control1]
  ...
  connect_bd_intf_net -intf_net dac_table_axim_0_m_axi_control [get_bd_intf_pins dac_table_axim_0/m_axi_control] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  # Create port connections
  connect_bd_net -net ap_clk_1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins capture/ap_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins photon_pipe/aclk] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins resets/slowest_sync_clk1] [get_bd_pins usp_rf_data_converter_0/m1_axis_aclk]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins resets/peripheral_aresetn2] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins usp_rf_data_converter_0/clk_adc1]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins resets/slowest_sync_clk2] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces dac_table_axim_0/Data_m_axi_control] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  ...
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces dac_table_axim_0/Data_m_axi_control] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces dac_table_axim_0/Data_m_axi_control] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces dac_table_axim_0/Data_m_axi_control] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI]
...
proc available_tcl_procs { } {
   ...
   puts "#"
   puts "#    create_hier_cell_capture parentCell nameHier"
   puts "#    create_hier_cell_photon_pipe parentCell nameHier"
   puts "#    create_hier_cell_resets parentCell nameHier"
   puts "#    create_hier_cell_opfb parentCell nameHier"
   puts "#    create_hier_cell_reschan parentCell nameHier"
   puts "#    create_hier_cell_fft parentCell nameHier"
   puts "#    create_hier_cell_firs parentCell nameHier"
