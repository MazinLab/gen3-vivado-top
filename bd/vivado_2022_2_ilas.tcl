...
set design_name vivado_2022_2_ilas
...
proc create_hier_cell_reload { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 M_AXIS4
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_clock_converter_0_M_AXIS] [get_bd_intf_pins M_AXIS4] [get_bd_intf_pins axis_clock_converter_0/M_AXIS]
...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_register_slice_4_M_AXIS [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins axis_register_slice_4/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ddc_control_1 [get_bd_intf_pins ddc_control] [get_bd_intf_pins axi_bram_ctrl_1/S_AXI]
  connect_bd_intf_net -intf_net dds_ddc_center_0_res_out [get_bd_intf_pins axis_register_slice_4/S_AXIS] [get_bd_intf_pins dds_ddc_center_0/res_out]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins bin_to_res/ap_clk] [get_bd_pins dds_ddc_center_0/ap_clk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins resonator_ddc_contro_0/ap_clk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins bin_to_res/ap_rst_n] [get_bd_pins dds_ddc_center_0/ap_rst_n] [get_bd_pins resonator_ddc_contro_0/ap_rst_n]
  connect_bd_net -net axi_bram_ctrl_1_bram_addr_a [get_bd_pins axi_bram_ctrl_1/bram_addr_a] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net axi_bram_ctrl_1_bram_clk_a [get_bd_pins axi_bram_ctrl_1/bram_clk_a] [get_bd_pins blk_mem_gen_0/clka]
  connect_bd_net -net axi_bram_ctrl_1_bram_en_a [get_bd_pins axi_bram_ctrl_1/bram_en_a] [get_bd_pins blk_mem_gen_0/ena]
  connect_bd_net -net axi_bram_ctrl_1_bram_we_a [get_bd_pins axi_bram_ctrl_1/bram_we_a] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net axi_bram_ctrl_1_bram_wrdata_a [get_bd_pins axi_bram_ctrl_1/bram_wrdata_a] [get_bd_pins blk_mem_gen_0/dina]
...
proc create_hier_cell_phasematch { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M_AXIS] [get_bd_intf_pins reload/M_AXIS4]
...
proc create_hier_cell_photon_pipe { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins M_AXIS4] [get_bd_intf_pins phasematch/M_AXIS]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set emio_uart1_rxd [ create_bd_port -dir I emio_uart1_rxd ]
  set emio_uart1_txd [ create_bd_port -dir O emio_uart1_txd ]
...
\
  ...
  # Create interface connections
connect_bd_intf_net -intf_net Conn [get_bd_intf_pins photon_pipe/M_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins photon_pipe/M_AXIS4] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/M03_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins capture/pipe_clk] [get_bd_pins photon_pipe/aclk] [get_bd_pins resets/slowest_sync_clk] [get_bd_pins rfdc/clk_out1] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net emio_uart1_rxd_0_1 [get_bd_ports emio_uart1_rxd] [get_bd_pins zynq_ultra_ps_e_0/emio_uart1_rxd]
  connect_bd_net -net photon_pipe_dout [get_bd_pins photon_pipe/dout] [get_bd_pins system_ila_0/probe0] [get_bd_pins xlconcat_0/In2]
  ...
  connect_bd_net -net resets_peripheral_aresetn_512 [get_bd_pins resets/peripheral_aresetn_512] [get_bd_pins rfdc/m2_axis_aresetn] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart1_txd [get_bd_ports emio_uart1_txd] [get_bd_pins zynq_ultra_ps_e_0/emio_uart1_txd]
  ...
  assign_bd_address -offset 0xA00C0000 -range 0x00004000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/reschan/axi_bram_ctrl_1/S_AXI/Mem0] -force
