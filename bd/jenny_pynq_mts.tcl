...
proc create_hier_cell_rfdc { parentCell nameHier } {
  ...
  create_bd_pin -dir I -type rst dac_reset
  ...
  set_property -dict [ list \
   ...
   CONFIG.DAC1_Outclk_Freq {32.000} \
   ...
   CONFIG.DAC3_Fabric_Freq {256.000} \
   CONFIG.DAC3_Multi_Tile_Sync {false} \
   CONFIG.DAC3_Outclk_Freq {32.000} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins adc0_clk] [get_bd_intf_pins usp_rf_data_converter_1/adc0_clk]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins vout30] [get_bd_intf_pins usp_rf_data_converter_1/vout30]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins s00_axis] [get_bd_intf_pins usp_rf_data_converter_1/s00_axis]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M03_AXIS [get_bd_intf_pins s20_axis] [get_bd_intf_pins usp_rf_data_converter_1/s20_axis]
  connect_bd_intf_net -intf_net dac2_clk_0_1 [get_bd_intf_pins dac2_clk] [get_bd_intf_pins usp_rf_data_converter_1/dac2_clk]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins s_axi] [get_bd_intf_pins usp_rf_data_converter_1/s_axi]
  connect_bd_intf_net -intf_net sysref_in_0_1 [get_bd_intf_pins sysref_in] [get_bd_intf_pins usp_rf_data_converter_1/sysref_in]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout00 [get_bd_intf_pins vout00] [get_bd_intf_pins usp_rf_data_converter_1/vout00]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout10 [get_bd_intf_pins vout10] [get_bd_intf_pins usp_rf_data_converter_1/vout10]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout20 [get_bd_intf_pins vout20] [get_bd_intf_pins usp_rf_data_converter_1/vout20]
  connect_bd_intf_net -intf_net vin0_01_0_1 [get_bd_intf_pins vin0_01] [get_bd_intf_pins usp_rf_data_converter_1/vin0_01]
  connect_bd_intf_net -intf_net vin0_23_1_1 [get_bd_intf_pins vin0_23] [get_bd_intf_pins usp_rf_data_converter_1/vin0_23]

  # Create port connections
  connect_bd_net -net RFingressReset_peripheral_aresetn [get_bd_pins dac_reset] [get_bd_pins usp_rf_data_converter_1/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_1/s1_axis_aresetn] [get_bd_pins usp_rf_data_converter_1/s2_axis_aresetn] [get_bd_pins usp_rf_data_converter_1/s3_axis_aresetn]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins dac_clk] [get_bd_pins usp_rf_data_converter_1/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s1_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s2_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s3_axis_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_out1] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins usp_rf_data_converter_1/m0_axis_aclk]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins clk_out2] [get_bd_pins clk_wiz_0/clk_out2]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins usp_rf_data_converter_1/s_axi_aresetn]
  connect_bd_net -net synchronizeSYSREF_dest_out [get_bd_pins user_sysref_dac] [get_bd_pins usp_rf_data_converter_1/user_sysref_dac]
  connect_bd_net -net usp_rf_data_converter_1_clk_adc0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins usp_rf_data_converter_1/clk_adc0]
  connect_bd_net -net usp_rf_data_converter_1_irq [get_bd_pins irq] [get_bd_pins usp_rf_data_converter_1/irq]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins usp_rf_data_converter_1/s_axi_aclk]
...
proc create_hier_cell_resets { parentCell nameHier } {
  ...
  connect_bd_net -net rst_usp_rf_data_converter_0_128M_peripheral_aresetn [get_bd_pins rst_clk_wiz_0_512M/ext_reset_in] [get_bd_pins rst_usp_rf_data_converter_0_100M/peripheral_aresetn]
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 -type rst dac_reset
  create_bd_pin -dir I -type rst ext_reset_in
  ...
  # Create instance: DACReset, and set properties
  set DACReset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 DACReset ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {77.041} \
   CONFIG.CLKOUT1_MATCHED_ROUTING {true} \
   CONFIG.CLKOUT1_PHASE_ERROR {70.929} \
  ...
  connect_bd_net -net RFingressReset_peripheral_aresetn [get_bd_pins dac_reset] [get_bd_pins DACReset/peripheral_aresetn]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clkRF] [get_bd_pins DACReset/slowest_sync_clk] [get_bd_pins MTSclkwiz/clk_out1] [get_bd_pins synchronizeSYSREF/dest_clk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins DACReset/dcm_locked] [get_bd_pins MTSclkwiz/locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins DACReset/ext_reset_in] [get_bd_pins MTSclkwiz/s_axi_aresetn] [get_bd_pins PSreset_control/peripheral_aresetn]
...
proc create_hier_cell_capture { parentCell nameHier } {
  ...
  connect_bd_net -net Net2 [get_bd_pins axis2mm_aresetn] [get_bd_pins JebConnect/S_AXI_ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axis2mm/S_AXI_ARESETN]
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set PL_CLK [ create_bd_port -dir I -from 0 -to 0 -type clk -freq_hz 256000000 PL_CLK ]
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins capture/control] [get_bd_intf_pins ps8_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins ps8_0_axi_periph/M04_AXI] [get_bd_intf_pins rfdc/s_axi]
  connect_bd_intf_net -intf_net rfdc_m00_axis [get_bd_intf_pins capture/raw_i] [get_bd_intf_pins rfdc/m00_axis]
  connect_bd_intf_net -intf_net rfdc_m02_axis [get_bd_intf_pins capture/raw_q] [get_bd_intf_pins rfdc/m02_axis]
  connect_bd_intf_net -intf_net rfdc_vout30 [get_bd_intf_ports vout30] [get_bd_intf_pins rfdc/vout30]
  connect_bd_intf_net -intf_net s00_axis_1 [get_bd_intf_pins dac_table/iout] [get_bd_intf_pins rfdc/s00_axis]
  connect_bd_intf_net -intf_net s20_axis_1 [get_bd_intf_pins dac_table/qout] [get_bd_intf_pins rfdc/s20_axis]
  connect_bd_intf_net -intf_net s_axi_lite_1 [get_bd_intf_pins clocktreeMTS/s_axi_lite] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout20 [get_bd_intf_ports vout20] [get_bd_intf_pins rfdc/vout20]
  connect_bd_intf_net -intf_net vin0_01_0_1 [get_bd_intf_ports vin0_01] [get_bd_intf_pins rfdc/vin0_01]
  connect_bd_intf_net -intf_net vin0_23_1_1 [get_bd_intf_ports vin0_23] [get_bd_intf_pins rfdc/vin0_23]
  ...
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins resets/never_reset_100]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net axis2mm_clk_1 [get_bd_pins capture/axis2mm_clk] [get_bd_pins rfdc/clk_out2]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clocktreeMTS/clkRF] [get_bd_pins dac_table/ap_clk] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins rfdc/dac_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins capture/pipe_clk] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins resets/slowest_sync_clk] [get_bd_pins rfdc/clk_out1]
  connect_bd_net -net clocktreeMTS_interrupt [get_bd_pins clocktreeMTS/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net dac_reset_1 [get_bd_pins clocktreeMTS/dac_reset] [get_bd_pins dac_table/ap_rst_n] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rfdc/dac_reset]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins capture/resetn] [get_bd_pins clocktreeMTS/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins rfdc/s_axi_aresetn]
  connect_bd_net -net resets_never_reset [get_bd_pins capture/pipe_aresetn] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins resets/never_reset_512]
  ...
  connect_bd_net -net synchronizeSYSREF_dest_out [get_bd_pins clocktreeMTS/UserSYSREF] [get_bd_pins rfdc/user_sysref_dac]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins capture/clk] [get_bd_pins clocktreeMTS/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins resets/slowest_sync_clk1] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clocktreeMTS/ext_reset_in] [get_bd_pins resets/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs clocktreeMTS/MTSclkwiz/s_axi_lite/Reg] -force
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs rfdc/usp_rf_data_converter_1/s_axi/Reg] -force
