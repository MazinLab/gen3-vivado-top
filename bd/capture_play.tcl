...
mazinlab:mkidgen3:write_axi256:0.14\
...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net bin_to_res_res_stream [get_bd_intf_pins M01_AXIS] [get_bd_intf_pins bin_to_res/res_stream]
...
proc create_hier_cell_resets { parentCell nameHier } {
  ...
  connect_bd_net -net rst_usp_rf_data_converter_0_128M_peripheral_aresetn [get_bd_pins peripheral_aresetn_100] [get_bd_pins rst_clk_wiz_0_512M/ext_reset_in] [get_bd_pins rst_usp_rf_data_converter_0_100M/peripheral_aresetn] [get_bd_pins rst_usp_rf_data_converter_0_256M/ext_reset_in]
...
proc create_hier_cell_capture { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 filtered
  ...
  # Create instance: write_axi256_0, and set properties
  set write_axi256_0 [ create_bd_cell -type ip -vlnv mazinlab:mkidgen3:write_axi256:0.14 write_axi256_0 ]
  ...
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins s_axi_control] [get_bd_intf_pins write_axi256_0/s_axi_control]
  connect_bd_intf_net -intf_net S03_AXI_1 [get_bd_intf_pins S03_AXI] [get_bd_intf_pins axi_smc/S01_AXI]
  ...
  connect_bd_intf_net -intf_net filter_iq_0_outstream [get_bd_intf_pins filter_iq_0/outstream] [get_bd_intf_pins write_axi256_0/filtered]
  connect_bd_intf_net -intf_net [get_bd_intf_nets filter_iq_0_outstream] [get_bd_intf_pins filtered] [get_bd_intf_pins write_axi256_0/filtered]
  ...
  connect_bd_intf_net -intf_net write_axi256_0_m_axi_gmem [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins write_axi256_0/m_axi_gmem]
  connect_bd_intf_net -intf_net [get_bd_intf_nets write_axi256_0_m_axi_gmem] [get_bd_intf_pins S00_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets write_axi256_0_m_axi_gmem]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins ap_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins filter_iq_0/ap_clk] [get_bd_pins write_axi256_0/ap_clk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins filter_iq_0/ap_rst_n] [get_bd_pins write_axi256_0/ap_rst_n]
  ...
  connect_bd_net -net write_axi256_0_filtered_TREADY [get_bd_pins filtered_TREADY1] [get_bd_pins write_axi256_0/filtered_TREADY]
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins capture/filtered] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins capture/s_axi_control]
  ...
  connect_bd_intf_net -intf_net istream_V_1 [get_bd_intf_pins photon_pipe/istream_V] [get_bd_intf_pins usp_rf_data_converter_0/m20_axis]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m22_axis [get_bd_intf_pins photon_pipe/qstream_V] [get_bd_intf_pins usp_rf_data_converter_0/m22_axis]
  ...
  # Create port connections
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins resets/never_reset_100]
  ...
  connect_bd_net -net capture_filtered_TREADY1 [get_bd_pins capture/filtered_TREADY1] [get_bd_pins system_ila_0/SLOT_1_AXIS_tready]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins capture/ap_clk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins photon_pipe/aclk] [get_bd_pins resets/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins usp_rf_data_converter_0/m2_axis_aclk]
  ...
  connect_bd_net -net resets_dout [get_bd_pins dac_table_axim_0/ap_rst_n] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins resets/never_reset_256]
  connect_bd_net -net resets_never_reset [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins capture/ap_rst_n] [get_bd_pins photon_pipe/ap_rst_n] [get_bd_pins resets/never_reset_512] [get_bd_pins system_ila_0/resetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins resets/slowest_sync_clk1] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_dac1 [get_bd_pins dac_table_axim_0/ap_clk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins resets/slowest_sync_clk2] [get_bd_pins usp_rf_data_converter_0/clk_dac0] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs capture/write_axi256_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0x000500000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces capture/write_axi256_0/Data_m_axi_gmem] [get_bd_addr_segs capture/ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
