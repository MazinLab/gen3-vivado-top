...
proc create_hier_cell_rfdc { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir O -type clk adc_pll_256mhz
  create_bd_pin -dir O -type clk adc_pll_512mhz
  create_bd_pin -dir I -type clk dac_axis_clk
  create_bd_pin -dir I -from 0 -to 0 -type rst dac_reset
  create_bd_pin -dir O -type intr irq
  create_bd_pin -dir O locked
  create_bd_pin -dir I -type rst m2_axis_aresetn
  create_bd_pin -dir I -type clk s_axi_aclk
  create_bd_pin -dir I -type rst s_axi_aresetn
  create_bd_pin -dir I user_sysref_dac_0
  ...
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins vout10] [get_bd_intf_pins usp_rf_data_converter_0/vout10]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins adc_pll_512mhz] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk]
  connect_bd_net -net clk_wiz_0_clk_out3 [get_bd_pins adc_pll_256mhz] [get_bd_pins clk_wiz_0/clk_out2]
  ...
  connect_bd_net -net s0_axis_aclk_1 [get_bd_pins dac_axis_clk] [get_bd_pins usp_rf_data_converter_0/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s1_axis_aclk] [get_bd_pins usp_rf_data_converter_0/s2_axis_aclk]
  connect_bd_net -net s1_axis_aresetn_1 [get_bd_pins dac_reset] [get_bd_pins usp_rf_data_converter_0/s0_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s1_axis_aresetn] [get_bd_pins usp_rf_data_converter_0/s2_axis_aresetn]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  connect_bd_net -net user_sysref_dac_0_1 [get_bd_pins user_sysref_dac_0] [get_bd_pins usp_rf_data_converter_0/user_sysref_dac]
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  # Create pins
  create_bd_pin -dir I -from 0 -to 0 -type clk BUFG_I_0
  create_bd_pin -dir O -type clk dac_256mhz
  ...
  create_bd_pin -dir I -from 0 -to 0 src_in_0
  create_bd_pin -dir O -from 0 -to 0 usr_sysref_dac_0
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_JITTER {77.815} \
   CONFIG.CLKOUT2_MATCHED_ROUTING {false} \
   CONFIG.CLKOUT2_PHASE_ERROR {65.345} \
  ...
  # Create instance: dac_256mhz_reset, and set properties
  set dac_256mhz_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 dac_256mhz_reset ]

  # Create instance: ps_reset_control, and set properties
  set ps_reset_control [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 ps_reset_control ]

  # Create instance: synchronize_PL_SYSREF, and set properties
  set synchronize_PL_SYSREF [ create_bd_cell -type ip -vlnv xilinx.com:ip:xpm_cdc_gen:1.0 synchronize_PL_SYSREF ]
  set_property -dict [ list \
   CONFIG.CDC_TYPE {xpm_cdc_single} \
   CONFIG.DEST_SYNC_FF {2} \
   CONFIG.INIT_SYNC_FF {true} \
   CONFIG.WIDTH {1} \
 ] $synchronize_PL_SYSREF

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_lite] [get_bd_intf_pins MTSclkwiz/s_axi_lite]

  # Create port connections
  connect_bd_net -net BUFG_I_0_1 [get_bd_pins BUFG_I_0] [get_bd_pins BUFG_PL_CLK/BUFG_I]
  connect_bd_net -net BUFG_PL_CLK_BUFG_O [get_bd_pins BUFG_PL_CLK/BUFG_O] [get_bd_pins MTSclkwiz/clk_in1] [get_bd_pins synchronize_PL_SYSREF/src_clk]
  connect_bd_net -net MTSclkwiz_clk_out1 [get_bd_pins dac_256mhz] [get_bd_pins MTSclkwiz/clk_out1] [get_bd_pins dac_256mhz_reset/slowest_sync_clk] [get_bd_pins synchronize_PL_SYSREF/dest_clk]
  connect_bd_net -net MTSclkwiz_interrupt [get_bd_pins interrupt] [get_bd_pins MTSclkwiz/interrupt]
  connect_bd_net -net MTSclkwiz_locked [get_bd_pins MTSclkwiz/locked] [get_bd_pins dac_256mhz_reset/dcm_locked]
  connect_bd_net -net ext_reset_in_1 [get_bd_pins pl_reset] [get_bd_pins ps_reset_control/ext_reset_in]
  connect_bd_net -net ps_reset_control_peripheral_aresetn [get_bd_pins peripheral_aresetn] [get_bd_pins MTSclkwiz/s_axi_aresetn] [get_bd_pins dac_256mhz_reset/ext_reset_in] [get_bd_pins ps_reset_control/peripheral_aresetn]
  connect_bd_net -net rf_ingress_reset_peripheral_aresetn [get_bd_pins dac_reset] [get_bd_pins dac_256mhz_reset/peripheral_aresetn]
  connect_bd_net -net s_axi_aclk_1 [get_bd_pins pl_clk0] [get_bd_pins MTSclkwiz/ref_clk] [get_bd_pins MTSclkwiz/s_axi_aclk] [get_bd_pins ps_reset_control/slowest_sync_clk]
  connect_bd_net -net src_in_0_1 [get_bd_pins src_in_0] [get_bd_pins synchronize_PL_SYSREF/src_in]
  connect_bd_net -net synchronize_PL_SYSREF_dest_out [get_bd_pins usr_sysref_dac_0] [get_bd_pins synchronize_PL_SYSREF/dest_out]
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net rfdc_i_axis [get_bd_intf_pins capture/raw_i] [get_bd_intf_pins rfdc/i_axis]
  ...
  # Create port connections
  connect_bd_net -net BUFG_I_0_1 [get_bd_ports PL_CLK] [get_bd_pins clocktreeMTS/BUFG_I_0]
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins resets/never_reset_100]
  connect_bd_net -net M05_ARESETN_1 [get_bd_pins capture/resetn] [get_bd_pins clocktreeMTS/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins rfdc/s_axi_aresetn]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins capture/pipe_clk] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins resets/slowest_sync_clk] [get_bd_pins rfdc/adc_pll_512mhz]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins capture/axis2mm_clk] [get_bd_pins rfdc/adc_pll_256mhz]
  connect_bd_net -net clocktreeMTS_clk_out2 [get_bd_pins clocktreeMTS/dac_256mhz] [get_bd_pins dac_table/ap_clk] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins rfdc/dac_axis_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net clocktreeMTS_interrupt [get_bd_pins clocktreeMTS/interrupt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net clocktreeMTS_peripheral_aresetn1 [get_bd_pins clocktreeMTS/dac_reset] [get_bd_pins dac_table/ap_rst_n] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins rfdc/dac_reset]
  ...
  connect_bd_net -net src_in_0_1 [get_bd_ports PL_SYSREF] [get_bd_pins clocktreeMTS/src_in_0]
  connect_bd_net -net user_sysref_dac_0_1 [get_bd_pins clocktreeMTS/usr_sysref_dac_0] [get_bd_pins rfdc/user_sysref_dac_0]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins capture/clk] [get_bd_pins clocktreeMTS/pl_clk0] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins resets/slowest_sync_clk1] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins clocktreeMTS/pl_reset] [get_bd_pins resets/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  ...
  assign_bd_address -offset 0xA00F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs clocktreeMTS/MTSclkwiz/s_axi_lite/Reg] -force
