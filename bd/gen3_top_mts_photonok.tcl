...
proc create_hier_cell_trigger_system { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net M00_AXIS_ACLK_1 [get_bd_pins TRIG_WRITER_CLK] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins axis_interconnect_0/M00_AXIS_ACLK] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins photon_maxi_0/ap_clk] [get_bd_pins postage_maxi_0/ap_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net M00_AXIS_ARESETN_1 [get_bd_pins TRIG_WRITER_RSTN] [get_bd_pins axis_interconnect_0/M00_AXIS_ARESETN] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins photon_maxi_0/ap_rst_n] [get_bd_pins postage_maxi_0/ap_rst_n] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net Net [get_bd_pins TRIG_PHOTO_CLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_interconnect_0/ACLK] [get_bd_pins axis_interconnect_0/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S01_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S02_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S03_AXIS_ACLK] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins postage_filter_0/ap_clk] [get_bd_pins trigger_1/ap_clk]
  connect_bd_net -net S03_AXIS_ARESETN_1 [get_bd_pins TRIG_PHOTO_RSTN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_interconnect_0/ARESETN] [get_bd_pins axis_interconnect_0/S00_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S01_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S02_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S03_AXIS_ARESETN] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins postage_filter_0/ap_rst_n] [get_bd_pins trigger_1/ap_rst_n]
  connect_bd_net -net photon_maxi_1_interrupt [get_bd_pins interrupt1] [get_bd_pins photon_maxi_0/interrupt]
  connect_bd_net -net postage_maxi_0_interrupt [get_bd_pins interrupt] [get_bd_pins postage_maxi_0/interrupt]
  connect_bd_net -net timestamp_TDATA_1 [get_bd_pins timestamp_TDATA] [get_bd_pins trigger_1/timestamp_TDATA]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins postage_filter_0/out_r_TREADY] [get_bd_pins trigger_1/timestamp_TVALID] [get_bd_pins xlconstant_0/dout]
