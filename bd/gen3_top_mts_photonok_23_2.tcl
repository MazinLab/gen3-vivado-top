...
# module references:
# lfsr_div, lfsr_div, lfsr_div, axis2mm, pps_synch
...
# Hierarchical cell: s03_couplers
proc create_hier_cell_s03_couplers { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_s03_couplers() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: s03_data_fifo, and set properties
  set s03_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 s03_data_fifo ]
  ...
  # Create instance: s03_regslice, and set properties
  set s03_regslice [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 s03_regslice ]

  # Create interface connections
  connect_bd_intf_net -intf_net s03_couplers_to_s03_regslice [get_bd_intf_pins S_AXIS] [get_bd_intf_pins s03_regslice/S_AXIS]
  connect_bd_intf_net -intf_net s03_data_fifo_to_s03_couplers [get_bd_intf_pins M_AXIS] [get_bd_intf_pins s03_data_fifo/M_AXIS]
  connect_bd_intf_net -intf_net s03_regslice_to_s03_data_fifo [get_bd_intf_pins s03_data_fifo/S_AXIS] [get_bd_intf_pins s03_regslice/M_AXIS]

  # Create port connections
  connect_bd_net -net AXIS_RD_DATA_COUNT_to_S_AXIS_RD_DATA_COUNT [get_bd_pins s03_data_fifo/axis_rd_data_count]
  connect_bd_net -net AXIS_WR_DATA_COUNT_to_S_AXIS_WR_DATA_COUNT [get_bd_pins s03_data_fifo/axis_wr_data_count]
  connect_bd_net -net M_AXIS_ACLK [get_bd_pins M_AXIS_ACLK] [get_bd_pins s03_data_fifo/s_axis_aclk]
  connect_bd_net -net M_AXIS_ARESETN [get_bd_pins M_AXIS_ARESETN] [get_bd_pins s03_data_fifo/s_axis_aresetn]
  connect_bd_net -net S_AXIS_ACLK [get_bd_pins S_AXIS_ACLK] [get_bd_pins s03_regslice/aclk]
  connect_bd_net -net S_AXIS_ARESETN [get_bd_pins S_AXIS_ARESETN] [get_bd_pins s03_regslice/aresetn]
...
proc create_hier_cell_s02_couplers { parentCell nameHier } {
  ...
  # Create instance: s02_data_fifo, and set properties
  set s02_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 s02_data_fifo ]
  set_property -dict [list \
    CONFIG.FIFO_DEPTH {16} \
    CONFIG.FIFO_MODE {1} \
    CONFIG.HAS_RD_DATA_COUNT {1} \
  ...
  set s02_regslice [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 s02_regslice ]

  # Create interface connections
  connect_bd_intf_net -intf_net s02_couplers_to_s02_regslice [get_bd_intf_pins S_AXIS] [get_bd_intf_pins s02_regslice/S_AXIS]
  connect_bd_intf_net -intf_net s02_data_fifo_to_s02_couplers [get_bd_intf_pins M_AXIS] [get_bd_intf_pins s02_data_fifo/M_AXIS]
  connect_bd_intf_net -intf_net s02_regslice_to_s02_data_fifo [get_bd_intf_pins s02_data_fifo/S_AXIS] [get_bd_intf_pins s02_regslice/M_AXIS]

  # Create port connections
  connect_bd_net -net AXIS_RD_DATA_COUNT_to_S_AXIS_RD_DATA_COUNT [get_bd_pins s02_data_fifo/axis_rd_data_count]
  connect_bd_net -net AXIS_WR_DATA_COUNT_to_S_AXIS_WR_DATA_COUNT [get_bd_pins s02_data_fifo/axis_wr_data_count]
  connect_bd_net -net M_AXIS_ACLK [get_bd_pins M_AXIS_ACLK] [get_bd_pins s02_data_fifo/s_axis_aclk]
  connect_bd_net -net M_AXIS_ARESETN [get_bd_pins M_AXIS_ARESETN] [get_bd_pins s02_data_fifo/s_axis_aresetn]
  connect_bd_net -net S_AXIS_ACLK [get_bd_pins S_AXIS_ACLK] [get_bd_pins s02_regslice/aclk]
  connect_bd_net -net S_AXIS_ARESETN [get_bd_pins S_AXIS_ARESETN] [get_bd_pins s02_regslice/aresetn]
...
proc create_hier_cell_s01_couplers { parentCell nameHier } {
  ...
  # Create instance: s01_data_fifo, and set properties
  set s01_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 s01_data_fifo ]
  set_property -dict [list \
    CONFIG.FIFO_DEPTH {16} \
    CONFIG.FIFO_MODE {1} \
    CONFIG.HAS_RD_DATA_COUNT {1} \
  ...
  set s01_regslice [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 s01_regslice ]

  # Create interface connections
  connect_bd_intf_net -intf_net s01_couplers_to_s01_regslice [get_bd_intf_pins S_AXIS] [get_bd_intf_pins s01_regslice/S_AXIS]
  connect_bd_intf_net -intf_net s01_data_fifo_to_s01_couplers [get_bd_intf_pins M_AXIS] [get_bd_intf_pins s01_data_fifo/M_AXIS]
  connect_bd_intf_net -intf_net s01_regslice_to_s01_data_fifo [get_bd_intf_pins s01_data_fifo/S_AXIS] [get_bd_intf_pins s01_regslice/M_AXIS]

  # Create port connections
  connect_bd_net -net AXIS_RD_DATA_COUNT_to_S_AXIS_RD_DATA_COUNT [get_bd_pins s01_data_fifo/axis_rd_data_count]
  connect_bd_net -net AXIS_WR_DATA_COUNT_to_S_AXIS_WR_DATA_COUNT [get_bd_pins s01_data_fifo/axis_wr_data_count]
  connect_bd_net -net M_AXIS_ACLK [get_bd_pins M_AXIS_ACLK] [get_bd_pins s01_data_fifo/s_axis_aclk]
  connect_bd_net -net M_AXIS_ARESETN [get_bd_pins M_AXIS_ARESETN] [get_bd_pins s01_data_fifo/s_axis_aresetn]
  connect_bd_net -net S_AXIS_ACLK [get_bd_pins S_AXIS_ACLK] [get_bd_pins s01_regslice/aclk]
  connect_bd_net -net S_AXIS_ARESETN [get_bd_pins S_AXIS_ARESETN] [get_bd_pins s01_regslice/aresetn]
...
proc create_hier_cell_s00_couplers { parentCell nameHier } {
  ...
  # Create instance: s00_data_fifo, and set properties
  set s00_data_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 s00_data_fifo ]
  set_property -dict [list \
    CONFIG.FIFO_DEPTH {16} \
    CONFIG.FIFO_MODE {1} \
    CONFIG.HAS_RD_DATA_COUNT {1} \
  ...
  set s00_regslice [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 s00_regslice ]

  # Create interface connections
  connect_bd_intf_net -intf_net s00_couplers_to_s00_regslice [get_bd_intf_pins S_AXIS] [get_bd_intf_pins s00_regslice/S_AXIS]
  connect_bd_intf_net -intf_net s00_data_fifo_to_s00_couplers [get_bd_intf_pins M_AXIS] [get_bd_intf_pins s00_data_fifo/M_AXIS]
  connect_bd_intf_net -intf_net s00_regslice_to_s00_data_fifo [get_bd_intf_pins s00_data_fifo/S_AXIS] [get_bd_intf_pins s00_regslice/M_AXIS]

  # Create port connections
  connect_bd_net -net AXIS_RD_DATA_COUNT_to_S_AXIS_RD_DATA_COUNT [get_bd_pins s00_data_fifo/axis_rd_data_count]
  connect_bd_net -net AXIS_WR_DATA_COUNT_to_S_AXIS_WR_DATA_COUNT [get_bd_pins s00_data_fifo/axis_wr_data_count]
  connect_bd_net -net M_AXIS_ACLK [get_bd_pins M_AXIS_ACLK] [get_bd_pins s00_data_fifo/s_axis_aclk]
  connect_bd_net -net M_AXIS_ARESETN [get_bd_pins M_AXIS_ARESETN] [get_bd_pins s00_data_fifo/s_axis_aresetn]
  connect_bd_net -net S_AXIS_ACLK [get_bd_pins S_AXIS_ACLK] [get_bd_pins s00_regslice/aclk]
  connect_bd_net -net S_AXIS_ARESETN [get_bd_pins S_AXIS_ARESETN] [get_bd_pins s00_regslice/aresetn]
...
proc create_hier_cell_m00_couplers { parentCell nameHier } {
  ...
  # Create instance: auto_cc, and set properties
  set auto_cc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_clock_converter:1.1 auto_cc ]

  # Create interface connections
  connect_bd_intf_net -intf_net auto_cc_to_m00_couplers [get_bd_intf_pins M_AXIS] [get_bd_intf_pins auto_cc/M_AXIS]
  connect_bd_intf_net -intf_net m00_couplers_to_auto_cc [get_bd_intf_pins S_AXIS] [get_bd_intf_pins auto_cc/S_AXIS]

  # Create port connections
  connect_bd_net -net M_AXIS_ACLK_1 [get_bd_pins M_AXIS_ACLK] [get_bd_pins auto_cc/m_axis_aclk]
  connect_bd_net -net M_AXIS_ARESETN_1 [get_bd_pins M_AXIS_ARESETN] [get_bd_pins auto_cc/m_axis_aresetn]
  connect_bd_net -net S_AXIS_ACLK_1 [get_bd_pins S_AXIS_ACLK] [get_bd_pins auto_cc/s_axis_aclk]
  connect_bd_net -net S_AXIS_ARESETN_1 [get_bd_pins S_AXIS_ARESETN] [get_bd_pins auto_cc/s_axis_aresetn]
...
proc create_hier_cell_reload { parentCell nameHier } {
  ...
  connect_bd_net -net axi_fifo_mm_s_0_interrupt [get_bd_pins axi_fifo_mm_s_0/interrupt] [get_bd_pins interrupt]
...
proc create_hier_cell_firs { parentCell nameHier } {
  ...
  # Create instance: axis_register_slice_0, and set properties
  set axis_register_slice_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_0 ]
  set_property CONFIG.HAS_TREADY {0} $axis_register_slice_0


  # Create instance: axis_register_slice_1, and set properties
  set axis_register_slice_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_1 ]
  set_property CONFIG.HAS_TREADY {0} $axis_register_slice_1
  ...
  set_property -dict [list \
    ...
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane0.coe} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane1.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane2.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane3.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane4.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane5.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane6.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane7.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane8.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane9.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane10.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane11.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane12.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane13.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane14.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_Fanout {false} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/4_tap_equiripple/lane15.coe} \
    CONFIG.Coefficient_Fractional_Bits {26} \
    CONFIG.Coefficient_Sets {256} \
    CONFIG.Coefficient_Sign {Signed} \
    CONFIG.Coefficient_Structure {Inferred} \
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins aresetn] [get_bd_pins opfb_fir_cfg_1/ap_rst_n] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn]
  connect_bd_net -net Net1 [get_bd_pins aclk] [get_bd_pins opfb_fir_cfg_1/ap_clk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins fir_compiler_10/aclk] [get_bd_pins fir_compiler_11/aclk] [get_bd_pins fir_compiler_12/aclk] [get_bd_pins fir_compiler_13/aclk] [get_bd_pins fir_compiler_14/aclk] [get_bd_pins fir_compiler_15/aclk] [get_bd_pins fir_compiler_1/aclk] [get_bd_pins fir_compiler_2/aclk] [get_bd_pins fir_compiler_3/aclk] [get_bd_pins fir_compiler_4/aclk] [get_bd_pins fir_compiler_5/aclk] [get_bd_pins fir_compiler_6/aclk] [get_bd_pins fir_compiler_7/aclk] [get_bd_pins fir_compiler_8/aclk] [get_bd_pins fir_compiler_9/aclk]
...
proc create_hier_cell_fft { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins ap_rst_n] [get_bd_pins pkg_fft_output_1/ap_rst_n] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins fftscale/s_axi_aresetn]
  connect_bd_net -net Net2 [get_bd_pins clk_out1] [get_bd_pins pkg_fft_output_1/ap_clk] [get_bd_pins ssrfft_16x4096_axis_0/clk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins fftscale/s_axi_aclk]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins fftscale/gpio_io_o] [get_bd_pins ssrfft_16x4096_axis_0/scale_in]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_0 [get_bd_pins ssrfft_16x4096_axis_0/biniq_0] [get_bd_pins pkg_fft_output_1/iq_0]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_1 [get_bd_pins ssrfft_16x4096_axis_0/biniq_1] [get_bd_pins pkg_fft_output_1/iq_1]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_2 [get_bd_pins ssrfft_16x4096_axis_0/biniq_2] [get_bd_pins pkg_fft_output_1/iq_2]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_3 [get_bd_pins ssrfft_16x4096_axis_0/biniq_3] [get_bd_pins pkg_fft_output_1/iq_3]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_4 [get_bd_pins ssrfft_16x4096_axis_0/biniq_4] [get_bd_pins pkg_fft_output_1/iq_4]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_5 [get_bd_pins ssrfft_16x4096_axis_0/biniq_5] [get_bd_pins pkg_fft_output_1/iq_5]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_6 [get_bd_pins ssrfft_16x4096_axis_0/biniq_6] [get_bd_pins pkg_fft_output_1/iq_6]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_7 [get_bd_pins ssrfft_16x4096_axis_0/biniq_7] [get_bd_pins pkg_fft_output_1/iq_7]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_8 [get_bd_pins ssrfft_16x4096_axis_0/biniq_8] [get_bd_pins pkg_fft_output_1/iq_8]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_9 [get_bd_pins ssrfft_16x4096_axis_0/biniq_9] [get_bd_pins pkg_fft_output_1/iq_9]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_10 [get_bd_pins ssrfft_16x4096_axis_0/biniq_10] [get_bd_pins pkg_fft_output_1/iq_10]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_11 [get_bd_pins ssrfft_16x4096_axis_0/biniq_11] [get_bd_pins pkg_fft_output_1/iq_11]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_12 [get_bd_pins ssrfft_16x4096_axis_0/biniq_12] [get_bd_pins pkg_fft_output_1/iq_12]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_13 [get_bd_pins ssrfft_16x4096_axis_0/biniq_13] [get_bd_pins pkg_fft_output_1/iq_13]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_14 [get_bd_pins ssrfft_16x4096_axis_0/biniq_14] [get_bd_pins pkg_fft_output_1/iq_14]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_15 [get_bd_pins ssrfft_16x4096_axis_0/biniq_15] [get_bd_pins pkg_fft_output_1/iq_15]
  connect_bd_net -net ssrfft_16x4096_axis_0_biniq_valid [get_bd_pins ssrfft_16x4096_axis_0/biniq_valid] [get_bd_pins pkg_fft_output_1/scale_ap_vld]
  connect_bd_net -net ssrfft_16x4096_axis_0_scale_out [get_bd_pins ssrfft_16x4096_axis_0/scale_out] [get_bd_pins pkg_fft_output_1/scale]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins pkg_fft_output_1/output_r_TREADY]
...
proc create_hier_cell_axis_interconnect_0 { parentCell nameHier } {
  ...
  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_axis_interconnect_0() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: s03_couplers
  create_hier_cell_s03_couplers $hier_obj s03_couplers

  # Create instance: s_arb_req_suppress_concat, and set properties
  set s_arb_req_suppress_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 s_arb_req_suppress_concat ]
  set_property -dict [list \
    CONFIG.IN0_WIDTH {1} \
    CONFIG.IN1_WIDTH {1} \
    CONFIG.IN2_WIDTH {1} \
  ...
  set xbar [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_switch:1.1 xbar ]
  set_property -dict [list \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axis_interconnect_0_to_s00_couplers [get_bd_intf_pins S00_AXIS] [get_bd_intf_pins s00_couplers/S_AXIS]
  connect_bd_intf_net -intf_net axis_interconnect_0_to_s01_couplers [get_bd_intf_pins S01_AXIS] [get_bd_intf_pins s01_couplers/S_AXIS]
  connect_bd_intf_net -intf_net axis_interconnect_0_to_s02_couplers [get_bd_intf_pins S02_AXIS] [get_bd_intf_pins s02_couplers/S_AXIS]
  connect_bd_intf_net -intf_net axis_interconnect_0_to_s03_couplers [get_bd_intf_pins S03_AXIS] [get_bd_intf_pins s03_couplers/S_AXIS]
  connect_bd_intf_net -intf_net m00_couplers_to_axis_interconnect_0 [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins m00_couplers/M_AXIS]
  connect_bd_intf_net -intf_net s00_couplers_to_xbar [get_bd_intf_pins s00_couplers/M_AXIS] [get_bd_intf_pins xbar/S00_AXIS]
  connect_bd_intf_net -intf_net s01_couplers_to_xbar [get_bd_intf_pins s01_couplers/M_AXIS] [get_bd_intf_pins xbar/S01_AXIS]
  connect_bd_intf_net -intf_net s02_couplers_to_xbar [get_bd_intf_pins s02_couplers/M_AXIS] [get_bd_intf_pins xbar/S02_AXIS]
  connect_bd_intf_net -intf_net s03_couplers_to_xbar [get_bd_intf_pins s03_couplers/M_AXIS] [get_bd_intf_pins xbar/S03_AXIS]
  connect_bd_intf_net -intf_net xbar_to_m00_couplers [get_bd_intf_pins m00_couplers/S_AXIS] [get_bd_intf_pins xbar/M00_AXIS]

  # Create port connections
  connect_bd_net -net M00_AXIS_ACLK_1 [get_bd_pins M00_AXIS_ACLK] [get_bd_pins m00_couplers/M_AXIS_ACLK]
  connect_bd_net -net M00_AXIS_ARESETN_1 [get_bd_pins M00_AXIS_ARESETN] [get_bd_pins m00_couplers/M_AXIS_ARESETN]
  connect_bd_net -net S00_AXIS_ACLK_1 [get_bd_pins S00_AXIS_ACLK] [get_bd_pins s00_couplers/S_AXIS_ACLK]
  connect_bd_net -net S00_AXIS_ARESETN_1 [get_bd_pins S00_AXIS_ARESETN] [get_bd_pins s00_couplers/S_AXIS_ARESETN]
  connect_bd_net -net S01_AXIS_ACLK_1 [get_bd_pins S01_AXIS_ACLK] [get_bd_pins s01_couplers/S_AXIS_ACLK]
  connect_bd_net -net S01_AXIS_ARESETN_1 [get_bd_pins S01_AXIS_ARESETN] [get_bd_pins s01_couplers/S_AXIS_ARESETN]
  connect_bd_net -net S02_AXIS_ACLK_1 [get_bd_pins S02_AXIS_ACLK] [get_bd_pins s02_couplers/S_AXIS_ACLK]
  connect_bd_net -net S02_AXIS_ARESETN_1 [get_bd_pins S02_AXIS_ARESETN] [get_bd_pins s02_couplers/S_AXIS_ARESETN]
  connect_bd_net -net S03_AXIS_ACLK_1 [get_bd_pins S03_AXIS_ACLK] [get_bd_pins s03_couplers/S_AXIS_ACLK]
  connect_bd_net -net S03_AXIS_ARESETN_1 [get_bd_pins S03_AXIS_ARESETN] [get_bd_pins s03_couplers/S_AXIS_ARESETN]
  connect_bd_net -net axis_interconnect_0_ACLK_net [get_bd_pins ACLK] [get_bd_pins m00_couplers/S_AXIS_ACLK] [get_bd_pins s00_couplers/M_AXIS_ACLK] [get_bd_pins s01_couplers/M_AXIS_ACLK] [get_bd_pins s02_couplers/M_AXIS_ACLK] [get_bd_pins s03_couplers/M_AXIS_ACLK] [get_bd_pins xbar/aclk]
  connect_bd_net -net axis_interconnect_0_ARESETN_net [get_bd_pins ARESETN] [get_bd_pins m00_couplers/S_AXIS_ARESETN] [get_bd_pins s00_couplers/M_AXIS_ARESETN] [get_bd_pins s01_couplers/M_AXIS_ARESETN] [get_bd_pins s02_couplers/M_AXIS_ARESETN] [get_bd_pins s03_couplers/M_AXIS_ARESETN] [get_bd_pins xbar/aresetn]
  connect_bd_net -net s00_arb_req_suppress_to_s_arb_req_suppress_concat [get_bd_pins S00_ARB_REQ_SUPPRESS] [get_bd_pins s_arb_req_suppress_concat/In0]
  connect_bd_net -net s01_arb_req_suppress_to_s_arb_req_suppress_concat [get_bd_pins S01_ARB_REQ_SUPPRESS] [get_bd_pins s_arb_req_suppress_concat/In1]
  connect_bd_net -net s02_arb_req_suppress_to_s_arb_req_suppress_concat [get_bd_pins S02_ARB_REQ_SUPPRESS] [get_bd_pins s_arb_req_suppress_concat/In2]
  connect_bd_net -net s03_arb_req_suppress_to_s_arb_req_suppress_concat [get_bd_pins S03_ARB_REQ_SUPPRESS] [get_bd_pins s_arb_req_suppress_concat/In3]
  connect_bd_net -net s_arb_req_suppress_concat_dout [get_bd_pins s_arb_req_suppress_concat/dout] [get_bd_pins xbar/s_req_suppress]
...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/lowpass.coe} \
  ...
  connect_bd_intf_net -intf_net axis_register_slice_1_M_AXIS [get_bd_intf_pins axis_register_slice_1/M_AXIS] [get_bd_intf_pins resonator_ddc_contro_0/res_in]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins bin_to_res/ap_clk] [get_bd_pins dds_ddc_center_0/ap_clk] [get_bd_pins resonator_ddc_contro_0/ap_clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins fir_compiler_0/aclk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins bin_to_res/ap_rst_n] [get_bd_pins dds_ddc_center_0/ap_rst_n] [get_bd_pins resonator_ddc_contro_0/ap_rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn]
  ...
  connect_bd_net -net resonator_ddc_contro_0_tones_and_centers_Clk_A [get_bd_pins resonator_ddc_contro_0/tones_and_centers_Clk_A] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net resonator_ddc_contro_0_tones_and_centers_EN_A [get_bd_pins resonator_ddc_contro_0/tones_and_centers_EN_A] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins bin_to_res/res_stream_TREADY]
...
proc create_hier_cell_phasematch { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 phasematch
  ...
  # Create instance: axis_combiner_0, and set properties
  set axis_combiner_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 axis_combiner_0 ]
  set_property CONFIG.NUM_SI {4} $axis_combiner_0
  ...
  # Create instance: axis_register_slice_2, and set properties
  set axis_register_slice_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_2 ]
  set_property CONFIG.HAS_TREADY {0} $axis_register_slice_2


  # Create instance: axis_register_slice_3, and set properties
  set axis_register_slice_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_3 ]
  set_property CONFIG.HAS_TREADY {0} $axis_register_slice_3


  # Create instance: axis_register_slice_4, and set properties
  set axis_register_slice_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_register_slice:1.1 axis_register_slice_4 ]
  set_property CONFIG.HAS_TREADY {0} $axis_register_slice_4
  ...
  set_property -dict [list \
    ...
    CONFIG.Clock_Frequency {300.0} \
    CONFIG.CoefficientSource {COE_File} \
    CONFIG.Coefficient_File {/work/jpsmith/Gen3/Last_Mile/23_2_initial_advanced/gen3-vivado-top/data/30-tap-unity_512x.coe} \
  ...
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins phasematch] [get_bd_intf_pins axis_register_slice_0/M_AXIS]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins aclk] [get_bd_pins reload/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_combiner_0/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins axis_register_slice_5/aclk] [get_bd_pins axis_register_slice_6/aclk] [get_bd_pins axis_register_slice_7/aclk] [get_bd_pins axis_register_slice_8/aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins axis_subset_converter_1/aclk] [get_bd_pins axis_subset_converter_2/aclk] [get_bd_pins axis_subset_converter_3/aclk] [get_bd_pins matched_filter_512x0/aclk] [get_bd_pins matched_filter_512x1/aclk] [get_bd_pins matched_filter_512x2/aclk] [get_bd_pins matched_filter_512x3/aclk]
  connect_bd_net -net Net1 [get_bd_pins aresetn] [get_bd_pins reload/aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_6/aresetn] [get_bd_pins axis_register_slice_7/aresetn] [get_bd_pins axis_register_slice_8/aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_subset_converter_2/aresetn] [get_bd_pins axis_subset_converter_3/aresetn]
  ...
  connect_bd_net -net reload_interrupt [get_bd_pins reload/interrupt] [get_bd_pins interrupt]
...
proc create_hier_cell_phase { parentCell nameHier } {
  ...
  connect_bd_net -net Net1 [get_bd_pins xlconstant_0/dout] [get_bd_pins attach_user_0/ap_rst_n] [get_bd_pins attach_user_0/out_r_TREADY] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_combiner_0/aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_0/m_axis_tready] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins axis_subset_converter_1/aresetn] [get_bd_pins axis_subset_converter_2/aresetn] [get_bd_pins axis_subset_converter_3/aresetn]
...
proc create_hier_cell_opfb { parentCell nameHier } {
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins adc_to_opfb_0/lanes_TREADY] [get_bd_pins fir_to_fft_1/output_r_TREADY]
...
proc create_hier_cell_switchboard { parentCell nameHier } {
  ...
  connect_bd_net -net Net [get_bd_pins pipe_clk] [get_bd_pins capture_upsizer_0/ap_clk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_switch_0/aclk] [get_bd_pins axis_switch_0/s_axi_ctrl_aclk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins pipe_aresetn] [get_bd_pins capture_upsizer_0/ap_rst_n] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_switch_0/aresetn] [get_bd_pins axis_switch_0/s_axi_ctrl_aresetn]
...
proc create_hier_cell_JebConnect { parentCell nameHier } {
  ...
  set_property CONFIG.WRITE_FIFO_DEPTH {32} $axi_data_fifo_1
  ...
  set_property CONFIG.MI_DATA_WIDTH {512} $axi_dwidth_converter_0
...
proc create_hier_cell_trigger_system { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 63 -to 0 timestamp_TDATA
  ...
  connect_bd_intf_net -intf_net axis_interconnect_0_M00_AXIS [get_bd_intf_pins axis_interconnect_0/M00_AXIS] [get_bd_intf_pins axis_register_slice_0/S_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins photon_maxi_0/photons]
  connect_bd_intf_net -intf_net axis_register_slice_2_M_AXIS [get_bd_intf_pins axis_register_slice_2/M_AXIS] [get_bd_intf_pins postage_filter_0/postage_stream]
  ...
  connect_bd_intf_net -intf_net trigger_1_postage_stream [get_bd_intf_pins axis_register_slice_2/S_AXIS] [get_bd_intf_pins trigger_1/postage_stream]
  connect_bd_intf_net -intf_net trigger_AXI_1 [get_bd_intf_pins trigger_AXI] [get_bd_intf_pins trigger_1/s_axi_control]

  # Create port connections
  connect_bd_net -net M00_AXIS_ACLK_1 [get_bd_pins TRIG_WRITER_CLK] [get_bd_pins axis_interconnect_0/M00_AXIS_ACLK] [get_bd_pins photon_maxi_0/ap_clk] [get_bd_pins postage_maxi_0/ap_clk] [get_bd_pins axis_data_fifo_0/m_axis_aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net M00_AXIS_ARESETN_1 [get_bd_pins TRIG_WRITER_RSTN] [get_bd_pins axis_interconnect_0/M00_AXIS_ARESETN] [get_bd_pins photon_maxi_0/ap_rst_n] [get_bd_pins postage_maxi_0/ap_rst_n] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net Net [get_bd_pins TRIG_PHOTO_CLK] [get_bd_pins axis_interconnect_0/ACLK] [get_bd_pins axis_interconnect_0/S00_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S01_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S02_AXIS_ACLK] [get_bd_pins axis_interconnect_0/S03_AXIS_ACLK] [get_bd_pins postage_filter_0/ap_clk] [get_bd_pins trigger_1/ap_clk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_register_slice_2/aclk]
  connect_bd_net -net S03_AXIS_ARESETN_1 [get_bd_pins TRIG_PHOTO_RSTN] [get_bd_pins axis_interconnect_0/ARESETN] [get_bd_pins axis_interconnect_0/S00_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S01_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S02_AXIS_ARESETN] [get_bd_pins axis_interconnect_0/S03_AXIS_ARESETN] [get_bd_pins postage_filter_0/ap_rst_n] [get_bd_pins trigger_1/ap_rst_n] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_register_slice_2/aresetn]
  connect_bd_net -net photon_maxi_1_interrupt [get_bd_pins photon_maxi_0/interrupt] [get_bd_pins interrupt1]
  connect_bd_net -net postage_maxi_0_interrupt [get_bd_pins postage_maxi_0/interrupt] [get_bd_pins interrupt]
  connect_bd_net -net timestamp_TDATA_1 [get_bd_pins timestamp_TDATA] [get_bd_pins trigger_1/timestamp_TDATA]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins postage_filter_0/out_r_TREADY] [get_bd_pins trigger_1/timestamp_TVALID]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins axis_interconnect_0/M00_AXIS_tready]
...
proc create_hier_cell_rfdc { parentCell nameHier } {
  ...
  set_property CONFIG.CONST_VAL {1} $DisableExtraDAC
  ...
  connect_bd_net -net usp_rf_data_converter_0_irq [get_bd_pins usp_rf_data_converter_0/irq] [get_bd_pins irq]
...
proc create_hier_cell_pps_synchronization { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 63 -to 0 timestamp_us
  ...
  connect_bd_net -net Net1 [get_bd_pins xlconstant_1/dout] [get_bd_pins util_ff_0/clk_enable] [get_bd_pins util_ff_1/clk_enable]
  ...
  connect_bd_net -net pps_synch_0_ns [get_bd_pins pps_synch_0/ns] [get_bd_pins ns] [get_bd_pins pps_synchronizer_con_0/ns_in] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net pps_synch_0_running [get_bd_pins pps_synch_0/running] [get_bd_pins running] [get_bd_pins pps_synchronizer_con_0/running_in]
  connect_bd_net -net pps_synch_0_secs [get_bd_pins pps_synch_0/secs] [get_bd_pins secs] [get_bd_pins pps_synchronizer_con_0/secs_in] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net pps_synch_0_subns [get_bd_pins pps_synch_0/subns] [get_bd_pins subns] [get_bd_pins pps_synchronizer_con_0/subns_in]
  connect_bd_net -net pps_synch_0_timestamp_us [get_bd_pins pps_synch_0/timestamp_us] [get_bd_pins timestamp_us]
  connect_bd_net -net pps_synchronizer_con_0_capture_mode_ctl [get_bd_pins pps_synchronizer_con_0/capture_mode_ctl] [get_bd_pins pps_synch_0/capture_mode]
  connect_bd_net -net pps_synchronizer_con_0_delay_ns_ctl [get_bd_pins pps_synchronizer_con_0/delay_ns_ctl] [get_bd_pins pps_synch_0/delay_ns]
  connect_bd_net -net pps_synchronizer_con_0_load_ns_ctl [get_bd_pins pps_synchronizer_con_0/load_ns_ctl] [get_bd_pins pps_synch_0/load_ns]
  connect_bd_net -net pps_synchronizer_con_0_load_secs_ctl [get_bd_pins pps_synchronizer_con_0/load_secs_ctl] [get_bd_pins pps_synch_0/load_secs]
  connect_bd_net -net pps_synchronizer_con_0_load_subns_ctl [get_bd_pins pps_synchronizer_con_0/load_subns_ctl] [get_bd_pins pps_synch_0/load_subns]
  connect_bd_net -net pps_synchronizer_con_0_lockout_ctl [get_bd_pins pps_synchronizer_con_0/lockout_ctl] [get_bd_pins pps_synch_0/lockout_ns]
  connect_bd_net -net pps_synchronizer_con_0_mode_ctl [get_bd_pins pps_synchronizer_con_0/mode_ctl] [get_bd_pins pps_synch_0/mode]
  connect_bd_net -net pps_synchronizer_con_0_ns_per_clk_ctl [get_bd_pins pps_synchronizer_con_0/ns_per_clk_ctl] [get_bd_pins pps_synch_0/ns_per_clk]
  connect_bd_net -net pps_synchronizer_con_0_pps_sel_ctl [get_bd_pins pps_synchronizer_con_0/pps_sel_ctl] [get_bd_pins pps_synch_0/pps_sel]
  connect_bd_net -net pps_synchronizer_con_0_rollover_thresh_ctl [get_bd_pins pps_synchronizer_con_0/rollover_thresh_ctl] [get_bd_pins pps_synch_0/rollover_thresh_ns]
  connect_bd_net -net pps_synchronizer_con_0_sanity_mode_ctl [get_bd_pins pps_synchronizer_con_0/sanity_mode_ctl] [get_bd_pins pps_synch_0/sanity_mode]
  connect_bd_net -net pps_synchronizer_con_0_subns_per_clk_ctl [get_bd_pins pps_synchronizer_con_0/subns_per_clk_ctl] [get_bd_pins pps_synch_0/subns_per_clk]
  ...
  connect_bd_net -net util_ff_1_Q [get_bd_pins util_ff_1/Q] [get_bd_pins pps_synch_0/pps]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins xlconcat_1/dout] [get_bd_pins util_ff_0/D]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins xlconcat_1/In2]
...
proc create_hier_cell_photon_pipe { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 PHASEMATCH_AXIS
  ...
  create_bd_pin -dir I -type rst aresetn
  create_bd_pin -dir O -from 6 -to 0 dout
  create_bd_pin -dir O -from 0 -to 0 -type intr interrupt
  ...
  connect_bd_intf_net -intf_net axis_register_slice_6_M_AXIS [get_bd_intf_pins LOIQ_AXIS] [get_bd_intf_pins axis_register_slice_6/M_AXIS]
  ...
  connect_bd_intf_net -intf_net phasematch_phasematch [get_bd_intf_pins PHASEMATCH_AXIS] [get_bd_intf_pins phasematch/phasematch]
  ...
  # Create port connections
  connect_bd_net -net ap_clk_1 [get_bd_pins aclk] [get_bd_pins opfb/ap_clk] [get_bd_pins phase/aclk] [get_bd_pins phasematch/aclk] [get_bd_pins reschan/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_broadcaster_2/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins axis_register_slice_5/aclk] [get_bd_pins axis_register_slice_6/aclk] [get_bd_pins axis_register_slice_7/aclk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins opfb/ap_rst_n] [get_bd_pins phasematch/aresetn] [get_bd_pins reschan/ap_rst_n] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_broadcaster_2/aresetn] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_6/aresetn] [get_bd_pins axis_register_slice_7/aresetn]
  connect_bd_net -net aresetn1_1 [get_bd_pins aresetn] [get_bd_pins phasematch/aresetn1]
  connect_bd_net -net phasematch_dout [get_bd_pins phasematch/dout] [get_bd_pins dout]
  connect_bd_net -net phasematch_interrupt [get_bd_pins phasematch/interrupt] [get_bd_pins interrupt]
...
proc create_hier_cell_capture { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins pipe_clk] [get_bd_pins filter_iq_0/ap_clk] [get_bd_pins filter_iq_1/ap_clk] [get_bd_pins filter_phase_0/ap_clk] [get_bd_pins filter_phase_1/ap_clk] [get_bd_pins pair_iq_0/ap_clk] [get_bd_pins switchboard/pipe_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins xpm_cdc_gen_0/src_clk] [get_bd_pins xpm_cdc_gen_1/src_clk] [get_bd_pins xpm_cdc_gen_2/src_clk]
  connect_bd_net -net Net1 [get_bd_pins axis2mm_clk] [get_bd_pins JebConnect/m_axis_aclk] [get_bd_pins switchboard/axis2mm_clk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins xpm_cdc_gen_0/dest_clk] [get_bd_pins xpm_cdc_gen_1/dest_clk] [get_bd_pins xpm_cdc_gen_2/dest_clk] [get_bd_pins axis2mm/S_AXI_ACLK]
  connect_bd_net -net Net2 [get_bd_pins axis2mm_aresetn] [get_bd_pins JebConnect/S_AXI_ARESETN] [get_bd_pins switchboard/axis2mm_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axis2mm/S_AXI_ARESETN]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins pipe_aresetn] [get_bd_pins filter_iq_0/ap_rst_n] [get_bd_pins filter_iq_1/ap_rst_n] [get_bd_pins filter_phase_0/ap_rst_n] [get_bd_pins filter_phase_1/ap_rst_n] [get_bd_pins pair_iq_0/ap_rst_n] [get_bd_pins switchboard/pipe_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn]
  connect_bd_net -net axis2mm_0_o_int [get_bd_pins axis2mm/o_int] [get_bd_pins int_capture]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins DDR_UI_CLK] [get_bd_pins JebConnect/DDR_UI_CLK] [get_bd_pins DDR_RESETGEN/slowest_sync_clk]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins DDR_UI_RESET] [get_bd_pins DDR_RESETGEN/ext_reset_in]
  connect_bd_net -net ddr4_0_c0_init_calib_complete [get_bd_pins ddr4_0/c0_init_calib_complete] [get_bd_pins DDR_RESETGEN/dcm_locked]
  connect_bd_net -net ns_in_1 [get_bd_pins ns_in] [get_bd_pins xpm_cdc_gen_0/src_in]
  ...
  connect_bd_net -net secs_in_1 [get_bd_pins secs_in] [get_bd_pins xpm_cdc_gen_1/src_in]
  connect_bd_net -net subns_in_1 [get_bd_pins subns_in] [get_bd_pins xpm_cdc_gen_2/src_in]
  ...
  connect_bd_net -net util_ds_buf_1_BUFG_O [get_bd_pins util_ds_buf_1/BUFG_O] [get_bd_pins ddr4_0/c0_sys_clk_i]
  connect_bd_net -net xpm_cdc_gen_0_dest_out [get_bd_pins xpm_cdc_gen_0/dest_out] [get_bd_pins axis2mm/ns_in]
  connect_bd_net -net xpm_cdc_gen_1_dest_out [get_bd_pins xpm_cdc_gen_1/dest_out] [get_bd_pins axis2mm/secs_in]
  connect_bd_net -net xpm_cdc_gen_2_dest_out [get_bd_pins xpm_cdc_gen_2/dest_out] [get_bd_pins axis2mm/subns_in]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: DACCDC1
proc create_hier_cell_DACCDC1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_DACCDC1() - Empty argument(s)!"}
     return
  }
  ...
  # Create pins
  create_bd_pin -dir I -type rst RF_256_ARESETN
  create_bd_pin -dir I -type clk RF_256_CLK
  create_bd_pin -dir I -type rst RF_512_ARESETN
  create_bd_pin -dir I -type clk RF_512_CLK
  ...
  # Create port connections
  connect_bd_net -net Net1 [get_bd_pins RF_512_CLK] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins axis_dwidth_converter_0/aclk]
  connect_bd_net -net RF_512_ARESETN_1 [get_bd_pins RF_512_ARESETN] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
  connect_bd_net -net s_axis_aclk_1 [get_bd_pins RF_256_CLK] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins axis_register_slice_1/aclk]
  connect_bd_net -net s_axis_aresetn_1 [get_bd_pins RF_256_ARESETN] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_register_slice_1/aresetn]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: DACCDC0
proc create_hier_cell_DACCDC0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_DACCDC0() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_Clocktree { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 -type intr MMCM_INT
  ...
  set_property CONFIG.C_BUF_TYPE {BUFG} $BUFG_PL_CLK
  ...
  set_property CONFIG.C_EXT_RST_WIDTH {16} $PL_RF_256_Reset
  ...
  # Create port connections
  connect_bd_net -net AXI_100_RESET_bus_struct_reset [get_bd_pins AXI_100_RESET/bus_struct_reset] [get_bd_pins DDR_SYS_RESET]
  connect_bd_net -net AXI_100_RESET_interconnect_aresetn [get_bd_pins AXI_100_RESET/interconnect_aresetn] [get_bd_pins AXI_100_ARESETN] [get_bd_pins PL_RF_256_Reset/ext_reset_in] [get_bd_pins RF_CLKGEN/s_axi_aresetn]
  ...
  connect_bd_net -net Net [get_bd_pins s_axi_aclk] [get_bd_pins AXI_100_RESET/slowest_sync_clk] [get_bd_pins RF_CLKGEN/s_axi_aclk] [get_bd_pins RF_CLKGEN/ref_clk]
  connect_bd_net -net PL_RF_256_Reset_interconnect_aresetn [get_bd_pins PL_RF_256_Reset/interconnect_aresetn] [get_bd_pins RF_256_ARESETN] [get_bd_pins PL_RF_512_Reset/ext_reset_in]
  connect_bd_net -net PL_RF_512_Reset_interconnect_aresetn [get_bd_pins PL_RF_512_Reset/interconnect_aresetn] [get_bd_pins RF_512_ARESETN]
  connect_bd_net -net RF_CLKGEN_interrupt [get_bd_pins RF_CLKGEN/interrupt] [get_bd_pins MMCM_INT]
  connect_bd_net -net SynchronizeSYSREF_dest_out [get_bd_pins SynchronizeSYSREF/dest_out] [get_bd_pins USER_SYSREF]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins RF_CLKGEN/locked] [get_bd_pins PL_RF_256_Reset/dcm_locked] [get_bd_pins PL_RF_512_Reset/dcm_locked]
  connect_bd_net -net clk_wiz_0_pl_rf_256 [get_bd_pins RF_CLKGEN/pl_rf_256] [get_bd_pins RF_256_CLK] [get_bd_pins PL_RF_256_Reset/slowest_sync_clk]
  connect_bd_net -net clk_wiz_0_pl_rf_512 [get_bd_pins RF_CLKGEN/pl_rf_512] [get_bd_pins RF_512_CLK] [get_bd_pins PL_RF_512_Reset/slowest_sync_clk] [get_bd_pins SynchronizeSYSREF/dest_clk]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Concat100, and set properties
  set Concat100 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 Concat100 ]
  set_property CONFIG.NUM_PORTS {5} $Concat100


  # Create instance: Concat256, and set properties
  set Concat256 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 Concat256 ]
  set_property -dict [list \
    CONFIG.IN1_WIDTH {1} \
    CONFIG.NUM_PORTS {2} \
  ] $Concat256
  ...
  # Create instance: Concat512, and set properties
  set Concat512 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 Concat512 ]
  set_property -dict [list \
    CONFIG.IN1_WIDTH {7} \
    CONFIG.NUM_PORTS {2} \
  ] $Concat512
  ...
  # Create instance: DACCDC0
  create_hier_cell_DACCDC0 [current_bd_instance .] DACCDC0

  # Create instance: DACCDC1
  create_hier_cell_DACCDC1 [current_bd_instance .] DACCDC1
  ...
  set_property CONFIG.C_M_AXI_GMEM_DATA_WIDTH {128} $dac_table
  ...
  # Create instance: lo_iq_fifo, and set properties
  set lo_iq_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 lo_iq_fifo ]
  set_property -dict [list \
...
\
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net DACCDC1_M_AXIS [get_bd_intf_pins DACCDC1/M_AXIS] [get_bd_intf_pins rfdc/s20_axis]
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins DACCDC1/S_AXIS] [get_bd_intf_pins dac_table/qout]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_1_M03_AXI [get_bd_intf_pins axi_interconnect_1/M03_AXI] [get_bd_intf_pins photon_pipe/fftscale_control]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_2_M00_AXIS [get_bd_intf_pins capture/phase1] [get_bd_intf_pins phasematch_broadcaster_2/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net dac_table_iout [get_bd_intf_pins DACCDC0/S_AXIS] [get_bd_intf_pins dac_table/iout]
  connect_bd_intf_net -intf_net instream_1 [get_bd_intf_pins capture/iq0] [get_bd_intf_pins photon_pipe/RAWIQ_AXIS]
  connect_bd_intf_net -intf_net iq1_1 [get_bd_intf_pins capture/iq1] [get_bd_intf_pins photon_pipe/DDCIQ_AXIS]
  connect_bd_intf_net -intf_net iq8x_in_1 [get_bd_intf_pins lo_iq_fifo/M_AXIS] [get_bd_intf_pins trigger_system/iq8x_in]
  ...
  connect_bd_intf_net -intf_net phase4x_in_1 [get_bd_intf_pins phasematch_broadcaster_2/M01_AXIS] [get_bd_intf_pins trigger_system/phase4x_in]
  connect_bd_intf_net -intf_net photon_pipe_LOIQ_AXIS [get_bd_intf_pins lo_iq_fifo/S_AXIS] [get_bd_intf_pins photon_pipe/LOIQ_AXIS]
  connect_bd_intf_net -intf_net photon_pipe_PHASEMATCH_AXIS [get_bd_intf_pins phasematch_broadcaster_2/S_AXIS] [get_bd_intf_pins photon_pipe/PHASEMATCH_AXIS]
  ...
  connect_bd_intf_net -intf_net postage_AXI_1 [get_bd_intf_pins ps8_0_axi_periph/M09_AXI] [get_bd_intf_pins trigger_system/postage_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M04_AXI [get_bd_intf_pins photon_pipe/reload_control] [get_bd_intf_pins ps8_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M05_AXI [get_bd_intf_pins Clocktree/s_axi_lite] [get_bd_intf_pins ps8_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M06_AXI [get_bd_intf_pins ps8_0_axi_periph/M06_AXI] [get_bd_intf_pins trigger_system/trigger_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M07_AXI [get_bd_intf_pins ps8_0_axi_periph/M07_AXI] [get_bd_intf_pins trigger_system/stamp_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M08_AXI [get_bd_intf_pins ps8_0_axi_periph/M08_AXI] [get_bd_intf_pins trigger_system/photon_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M10_AXI [get_bd_intf_pins pps_synchronization/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M10_AXI]
  ...
  connect_bd_intf_net -intf_net s00_axis_1 [get_bd_intf_pins DACCDC0/M_AXIS] [get_bd_intf_pins rfdc/s00_axis]
  ...
  connect_bd_intf_net -intf_net trigsys_TRIG_MAXI [get_bd_intf_pins trigger_system/TRIG_MAXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  ...
  # Create port connections
  connect_bd_net -net Clocktree_MMCM_INT [get_bd_pins Clocktree/MMCM_INT] [get_bd_pins Concat100/In3]
  connect_bd_net -net Clocktree_bus_struct_reset [get_bd_pins Clocktree/DDR_SYS_RESET] [get_bd_pins capture/sys_rst]
  connect_bd_net -net Concat100_dout [get_bd_pins Concat100/dout] [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net Concat256_dout [get_bd_pins Concat256/dout] [get_bd_pins Concat100/In4]
  connect_bd_net -net Concat512_dout [get_bd_pins Concat512/dout] [get_bd_pins Concat100/In1]
  connect_bd_net -net M02_ARESETN_1 [get_bd_pins Clocktree/AXI_100_ARESETN] [get_bd_pins photon_pipe/aresetn] [get_bd_pins rfdc/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/M05_ARESETN] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net RF_256_ARESETN [get_bd_pins Clocktree/RF_256_ARESETN] [get_bd_pins DACCDC0/RF_256_ARESETN] [get_bd_pins DACCDC1/RF_256_ARESETN] [get_bd_pins capture/axis2mm_aresetn] [get_bd_pins dac_table/ap_rst_n] [get_bd_pins trigger_system/TRIG_WRITER_RSTN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M08_ARESETN] [get_bd_pins ps8_0_axi_periph/M09_ARESETN] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net RF_256_CLK [get_bd_pins Clocktree/RF_256_CLK] [get_bd_pins DACCDC0/RF_256_CLK] [get_bd_pins DACCDC1/RF_256_CLK] [get_bd_pins capture/axis2mm_clk] [get_bd_pins dac_table/ap_clk] [get_bd_pins lfsr_div_1/clk] [get_bd_pins trigger_system/TRIG_WRITER_CLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M08_ACLK] [get_bd_pins ps8_0_axi_periph/M09_ACLK] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
  connect_bd_net -net RF_512_ARESETN [get_bd_pins Clocktree/RF_512_ARESETN] [get_bd_pins DACCDC0/RF_512_ARESETN] [get_bd_pins DACCDC1/RF_512_ARESETN] [get_bd_pins capture/pipe_aresetn] [get_bd_pins photon_pipe/ap_rst_n] [get_bd_pins pps_synchronization/ap_rst_n] [get_bd_pins rfdc/RF_512_ARESETN] [get_bd_pins trigger_system/TRIG_PHOTO_RSTN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins axi_interconnect_1/M02_ARESETN] [get_bd_pins axi_interconnect_1/M03_ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins lo_iq_fifo/s_axis_aresetn] [get_bd_pins phasematch_broadcaster_2/aresetn] [get_bd_pins ps8_0_axi_periph/M06_ARESETN] [get_bd_pins ps8_0_axi_periph/M07_ARESETN] [get_bd_pins ps8_0_axi_periph/M10_ARESETN] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net RF_512_CLK [get_bd_pins Clocktree/RF_512_CLK] [get_bd_pins DACCDC0/RF_512_CLK] [get_bd_pins DACCDC1/RF_512_CLK] [get_bd_pins capture/pipe_clk] [get_bd_pins lfsr_div_0/clk] [get_bd_pins photon_pipe/aclk] [get_bd_pins pps_synchronization/ap_clk] [get_bd_pins rfdc/RF_512_CLK] [get_bd_pins trigger_system/TRIG_PHOTO_CLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins axi_interconnect_1/M02_ACLK] [get_bd_pins axi_interconnect_1/M03_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins lo_iq_fifo/s_axis_aclk] [get_bd_pins phasematch_broadcaster_2/aclk] [get_bd_pins ps8_0_axi_periph/M06_ACLK] [get_bd_pins ps8_0_axi_periph/M07_ACLK] [get_bd_pins ps8_0_axi_periph/M10_ACLK]
  connect_bd_net -net USER_SYSREF [get_bd_pins Clocktree/USER_SYSREF] [get_bd_pins pps_synchronization/sysref] [get_bd_pins rfdc/user_sysref]
  ...
  connect_bd_net -net capture_c0_ddr4_ui_clk_sync_rst [get_bd_pins capture/DDR_UI_RESET] [get_bd_pins Clocktree/DDR4_RESET]
  connect_bd_net -net capture_int_capture [get_bd_pins capture/int_capture] [get_bd_pins Concat512/In0]
  ...
  connect_bd_net -net photon_pipe_dout [get_bd_pins photon_pipe/dout] [get_bd_pins Concat512/In1]
  connect_bd_net -net photon_pipe_interrupt [get_bd_pins photon_pipe/interrupt] [get_bd_pins Concat100/In2]
  ...
  connect_bd_net -net pps_synchronization_ns [get_bd_pins pps_synchronization/ns] [get_bd_pins capture/ns_in]
  connect_bd_net -net pps_synchronization_secs [get_bd_pins pps_synchronization/secs] [get_bd_pins capture/secs_in]
  connect_bd_net -net pps_synchronization_subns [get_bd_pins pps_synchronization/subns] [get_bd_pins capture/subns_in]
  connect_bd_net -net rfdc_irq [get_bd_pins rfdc/irq] [get_bd_pins Concat100/In0]
  ...
  connect_bd_net -net trigsys_interrupt [get_bd_pins trigger_system/interrupt] [get_bd_pins Concat256/In0]
  connect_bd_net -net trigsys_interrupt1 [get_bd_pins trigger_system/interrupt1] [get_bd_pins Concat256/In1]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc1 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins Clocktree/s_axi_aclk] [get_bd_pins lfsr_div_2/clk] [get_bd_pins photon_pipe/reload_aclk] [get_bd_pins rfdc/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/M05_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_ports rgbleds_6bits]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins axis_broadcaster_0/s_axis_tvalid] [get_bd_pins axis_broadcaster_1/s_axis_tvalid]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins Clocktree/ext_reset_in]
  ...
  assign_bd_address -offset 0xA0100000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Clocktree/RF_CLKGEN/s_axi_lite/Reg] -force
  assign_bd_address -offset 0xA00C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/reschan/axi_bram_ctrl_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA00E0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/phasematch/reload/axi_fifo_mm_s_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0xA0140000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs trigger_system/photon_maxi_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0120000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs trigger_system/postage_filter_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0130000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs trigger_system/postage_maxi_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0110000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pps_synchronization/pps_synchronizer_con_0/s_axi_control/Reg] -force
  assign_bd_address -offset 0xA0150000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs trigger_system/trigger_1/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces trigger_system/photon_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces trigger_system/photon_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces trigger_system/photon_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces trigger_system/postage_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces trigger_system/postage_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces trigger_system/postage_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_QSPI] -force
  ...
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces trigger_system/photon_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces trigger_system/postage_maxi_0/Data_m_axi_gmem] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM]
