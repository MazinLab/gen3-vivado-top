...
proc create_hier_cell_phasematch { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_CONFIG

  create_bd_intf_pin -mode Monitor -vlnv xilinx.com:interface:axis_rtl:1.0 S_AXIS_RELOAD
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets axis_register_slice_5_M_AXIS] [get_bd_intf_pins M_AXIS] [get_bd_intf_pins axis_register_slice_5/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_register_slice_5_M_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets reload_M00_AXIS] [get_bd_intf_pins S_AXIS_CONFIG] [get_bd_intf_pins reload/M00_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets reload_M00_AXIS]
  ...
  connect_bd_intf_net -intf_net [get_bd_intf_nets reload_M_AXIS] [get_bd_intf_pins S_AXIS_RELOAD] [get_bd_intf_pins reload/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets reload_M_AXIS]
...
proc create_hier_cell_photon_pipe { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_control] [get_bd_intf_pins iq_gen_0/s_axi_control]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins M_AXIS1] [get_bd_intf_pins phasematch/M_AXIS]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins reload_control] [get_bd_intf_pins phasematch/S_AXI]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S_AXIS_CONFIG] [get_bd_intf_pins phasematch/S_AXIS_CONFIG]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins S_AXIS_RELOAD] [get_bd_intf_pins phasematch/S_AXIS_RELOAD]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_4_M_AXIS [get_bd_intf_pins M00_AXIS] [get_bd_intf_pins axis_register_slice_4/M_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets axis_register_slice_4_M_AXIS]
  connect_bd_intf_net -intf_net iq_gen_0_phase [get_bd_intf_pins axis_broadcaster_2/S_AXIS] [get_bd_intf_pins iq_gen_0/phase]
  ...
  # Create port connections
  connect_bd_net -net ap_clk_1 [get_bd_pins aclk] [get_bd_pins axis_broadcaster_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins iq_gen_0/ap_clk] [get_bd_pins phasematch/aclk]
  connect_bd_net -net ap_rst_n_1 [get_bd_pins ap_rst_n] [get_bd_pins axis_broadcaster_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins iq_gen_0/ap_rst_n] [get_bd_pins phasematch/aresetn]
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins photon_pipe/M_AXIS1] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins photon_pipe/S_AXIS_CONFIG] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins photon_pipe/S_AXIS_RELOAD] [get_bd_intf_pins system_ila_0/SLOT_4_AXIS]
  connect_bd_intf_net -intf_net adc0_clk_1 [get_bd_intf_ports adc0_clk] [get_bd_intf_pins rfdc/adc0_clk]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins photon_pipe/s_axi_control]
  ...
  connect_bd_intf_net -intf_net phase0_1 [get_bd_intf_pins capture/phase0] [get_bd_intf_pins photon_pipe/M00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets phase0_1] [get_bd_intf_pins photon_pipe/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_interconnect_1/M01_ACLK] [get_bd_pins capture/pipe_clk] [get_bd_pins photon_pipe/aclk] [get_bd_pins resets/slowest_sync_clk] [get_bd_pins rfdc/clk_out1] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net resets_never_reset [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/M01_ARESETN] [get_bd_pins capture/pipe_aresetn] [get_bd_pins photon_pipe/ap_rst_n] [get_bd_pins resets/never_reset_512]
  ...
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs photon_pipe/iq_gen_0/s_axi_control/Reg] -force
