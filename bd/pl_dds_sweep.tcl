...
slaclab:hls:stream_sign_flip:1.0\
...
proc create_hier_cell_reschan { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.Coefficient_File {../../../../../../../../data/8_tap_lowpass/lowpass_8tap.coe} \
...
# Hierarchical cell: dac_upconversion
proc create_hier_cell_dac_upconversion { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_dac_upconversion() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 DAC_I_in

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 DAC_I_out

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 DAC_Q_in

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 DAC_Q_out

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 DDS


  # Create pins
  create_bd_pin -dir I -type rst m_axis_aresetn
  create_bd_pin -dir I -type clk pl_rf_512
  ...
  # Create instance: cmpy_2, and set properties
  set cmpy_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmpy:6.0 cmpy_2 ]
  set_property -dict [ list \
   CONFIG.OutputWidth {16} \
   CONFIG.RoundMode {Truncate} \
 ] $cmpy_2

  # Create instance: cmpy_3, and set properties
  set cmpy_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmpy:6.0 cmpy_3 ]
  set_property -dict [ list \
   CONFIG.OutputWidth {16} \
   CONFIG.RoundMode {Truncate} \
 ] $cmpy_3

  # Create instance: cmpy_4, and set properties
  set cmpy_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmpy:6.0 cmpy_4 ]
  set_property -dict [ list \
   CONFIG.OutputWidth {16} \
   CONFIG.RoundMode {Truncate} \
 ] $cmpy_4

  # Create instance: cmpy_5, and set properties
  set cmpy_5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmpy:6.0 cmpy_5 ]
  set_property -dict [ list \
   CONFIG.OutputWidth {16} \
   CONFIG.RoundMode {Truncate} \
 ] $cmpy_5

  # Create instance: cmpy_6, and set properties
  set cmpy_6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmpy:6.0 cmpy_6 ]
  set_property -dict [ list \
   CONFIG.OutputWidth {16} \
   CONFIG.RoundMode {Truncate} \
 ] $cmpy_6

  # Create instance: cmpy_7, and set properties
  set cmpy_7 [ create_bd_cell -type ip -vlnv xilinx.com:ip:cmpy:6.0 cmpy_7 ]
  set_property -dict [ list \
   CONFIG.OutputWidth {16} \
   CONFIG.RoundMode {Truncate} \
 ] $cmpy_7

  # Create instance: dac_i_upconverted, and set properties
  set dac_i_upconverted [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_i_upconverted ]
  set_property -dict [ list \
   CONFIG.NUM_SI {8} \
 ] $dac_i_upconverted

  # Create instance: dac_iq_0, and set properties
  set dac_iq_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_0 ]

  # Create instance: dac_iq_1, and set properties
  set dac_iq_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_1 ]

  # Create instance: dac_iq_2, and set properties
  set dac_iq_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_2 ]

  # Create instance: dac_iq_3, and set properties
  set dac_iq_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_3 ]

  # Create instance: dac_iq_4, and set properties
  set dac_iq_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_4 ]

  # Create instance: dac_iq_5, and set properties
  set dac_iq_5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_5 ]

  # Create instance: dac_iq_6, and set properties
  set dac_iq_6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_6 ]

  # Create instance: dac_iq_7, and set properties
  set dac_iq_7 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_iq_7 ]

  # Create instance: dac_q_upconverted, and set properties
  set dac_q_upconverted [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 dac_q_upconverted ]
  set_property -dict [ list \
   CONFIG.NUM_SI {8} \
 ] $dac_q_upconverted

  # Create instance: split_dac_i, and set properties
  set split_dac_i [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_dac_i ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
   CONFIG.M02_TDATA_REMAP {tdata[47:32]} \
   CONFIG.M03_TDATA_REMAP {tdata[63:48]} \
   CONFIG.M04_TDATA_REMAP {tdata[79:64]} \
   CONFIG.M05_TDATA_REMAP {tdata[95:80]} \
   CONFIG.M06_TDATA_REMAP {tdata[111:96]} \
   CONFIG.M07_TDATA_REMAP {tdata[127:112]} \
   CONFIG.M_TDATA_NUM_BYTES {2} \
   CONFIG.NUM_MI {8} \
   CONFIG.S_TDATA_NUM_BYTES {16} \
 ] $split_dac_i

  # Create instance: split_dac_q, and set properties
  set split_dac_q [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_dac_q ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_dds_iq, and set properties
  set split_dds_iq [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_dds_iq ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[31:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[63:32]} \
  ...
  # Create instance: split_iq_0, and set properties
  set split_iq_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_0 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_iq_1, and set properties
  set split_iq_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_1 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_iq_2, and set properties
  set split_iq_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_2 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_iq_3, and set properties
  set split_iq_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_3 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_iq_4, and set properties
  set split_iq_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_4 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_iq_5, and set properties
  set split_iq_5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_5 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_iq_6, and set properties
  set split_iq_6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_6 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_iq_7, and set properties
  set split_iq_7 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_iq_7 ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins DAC_I_in] [get_bd_intf_pins split_dac_i/S_AXIS]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins DAC_Q_in] [get_bd_intf_pins split_dac_q/S_AXIS]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins DAC_Q_out] [get_bd_intf_pins dac_q_upconverted/M_AXIS]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins DAC_I_out] [get_bd_intf_pins dac_i_upconverted/M_AXIS]
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins DDS] [get_bd_intf_pins split_dds_iq/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S00_AXIS] [get_bd_intf_pins split_iq_0/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_10_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S07_AXIS] [get_bd_intf_pins split_iq_7/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins cmpy_0/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins cmpy_1/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M01_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M02_AXIS [get_bd_intf_pins cmpy_2/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M02_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M03_AXIS [get_bd_intf_pins cmpy_3/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M03_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M04_AXIS [get_bd_intf_pins cmpy_4/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M04_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M05_AXIS [get_bd_intf_pins cmpy_5/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M05_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M06_AXIS [get_bd_intf_pins cmpy_6/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M06_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M07_AXIS [get_bd_intf_pins cmpy_7/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M07_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M00_AXIS [get_bd_intf_pins dac_iq_0/S00_AXIS] [get_bd_intf_pins split_dac_i/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M01_AXIS [get_bd_intf_pins dac_iq_1/S00_AXIS] [get_bd_intf_pins split_dac_i/M01_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M02_AXIS [get_bd_intf_pins dac_iq_2/S00_AXIS] [get_bd_intf_pins split_dac_i/M02_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M03_AXIS [get_bd_intf_pins dac_iq_3/S00_AXIS] [get_bd_intf_pins split_dac_i/M03_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M04_AXIS [get_bd_intf_pins dac_iq_4/S00_AXIS] [get_bd_intf_pins split_dac_i/M04_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M05_AXIS [get_bd_intf_pins dac_iq_5/S00_AXIS] [get_bd_intf_pins split_dac_i/M05_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M06_AXIS [get_bd_intf_pins dac_iq_6/S00_AXIS] [get_bd_intf_pins split_dac_i/M06_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M07_AXIS [get_bd_intf_pins dac_iq_7/S00_AXIS] [get_bd_intf_pins split_dac_i/M07_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M00_AXIS [get_bd_intf_pins dac_iq_0/S01_AXIS] [get_bd_intf_pins split_dac_q/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M01_AXIS [get_bd_intf_pins dac_iq_1/S01_AXIS] [get_bd_intf_pins split_dac_q/M01_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M02_AXIS [get_bd_intf_pins dac_iq_2/S01_AXIS] [get_bd_intf_pins split_dac_q/M02_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M03_AXIS [get_bd_intf_pins dac_iq_3/S01_AXIS] [get_bd_intf_pins split_dac_q/M03_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M04_AXIS [get_bd_intf_pins dac_iq_4/S01_AXIS] [get_bd_intf_pins split_dac_q/M04_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M05_AXIS [get_bd_intf_pins dac_iq_5/S01_AXIS] [get_bd_intf_pins split_dac_q/M05_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M06_AXIS [get_bd_intf_pins dac_iq_6/S01_AXIS] [get_bd_intf_pins split_dac_q/M06_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M07_AXIS [get_bd_intf_pins dac_iq_7/S01_AXIS] [get_bd_intf_pins split_dac_q/M07_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_4_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S01_AXIS] [get_bd_intf_pins split_iq_1/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_5_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S02_AXIS] [get_bd_intf_pins split_iq_2/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_6_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S03_AXIS] [get_bd_intf_pins split_iq_3/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_7_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S04_AXIS] [get_bd_intf_pins split_iq_4/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_8_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S05_AXIS] [get_bd_intf_pins split_iq_5/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_9_M00_AXIS [get_bd_intf_pins dac_i_upconverted/S06_AXIS] [get_bd_intf_pins split_iq_6/M00_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_pins cmpy_0/S_AXIS_A] [get_bd_intf_pins dac_iq_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_1_M_AXIS [get_bd_intf_pins cmpy_1/S_AXIS_A] [get_bd_intf_pins dac_iq_1/M_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_2_M_AXIS [get_bd_intf_pins cmpy_2/S_AXIS_A] [get_bd_intf_pins dac_iq_2/M_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_3_M_AXIS [get_bd_intf_pins cmpy_3/S_AXIS_A] [get_bd_intf_pins dac_iq_3/M_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_4_M_AXIS [get_bd_intf_pins cmpy_4/S_AXIS_A] [get_bd_intf_pins dac_iq_4/M_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_5_M_AXIS [get_bd_intf_pins cmpy_5/S_AXIS_A] [get_bd_intf_pins dac_iq_5/M_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_6_M_AXIS [get_bd_intf_pins cmpy_6/S_AXIS_A] [get_bd_intf_pins dac_iq_6/M_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_7_M_AXIS [get_bd_intf_pins cmpy_7/S_AXIS_A] [get_bd_intf_pins dac_iq_7/M_AXIS]
  connect_bd_intf_net -intf_net cmpy_0_M_AXIS_DOUT [get_bd_intf_pins cmpy_0/M_AXIS_DOUT] [get_bd_intf_pins split_iq_0/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_1_M_AXIS_DOUT [get_bd_intf_pins cmpy_1/M_AXIS_DOUT] [get_bd_intf_pins split_iq_1/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_2_M_AXIS_DOUT [get_bd_intf_pins cmpy_2/M_AXIS_DOUT] [get_bd_intf_pins split_iq_2/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_3_M_AXIS_DOUT [get_bd_intf_pins cmpy_3/M_AXIS_DOUT] [get_bd_intf_pins split_iq_3/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_4_M_AXIS_DOUT [get_bd_intf_pins cmpy_4/M_AXIS_DOUT] [get_bd_intf_pins split_iq_4/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_5_M_AXIS_DOUT [get_bd_intf_pins cmpy_5/M_AXIS_DOUT] [get_bd_intf_pins split_iq_5/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_6_M_AXIS_DOUT [get_bd_intf_pins cmpy_6/M_AXIS_DOUT] [get_bd_intf_pins split_iq_6/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_7_M_AXIS_DOUT [get_bd_intf_pins cmpy_7/M_AXIS_DOUT] [get_bd_intf_pins split_iq_7/S_AXIS]
  connect_bd_intf_net -intf_net split_iq_0_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S00_AXIS] [get_bd_intf_pins split_iq_0/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_1_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S01_AXIS] [get_bd_intf_pins split_iq_1/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_2_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S02_AXIS] [get_bd_intf_pins split_iq_2/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_3_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S03_AXIS] [get_bd_intf_pins split_iq_3/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_4_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S04_AXIS] [get_bd_intf_pins split_iq_4/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_5_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S05_AXIS] [get_bd_intf_pins split_iq_5/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_6_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S06_AXIS] [get_bd_intf_pins split_iq_6/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_7_M01_AXIS [get_bd_intf_pins dac_q_upconverted/S07_AXIS] [get_bd_intf_pins split_iq_7/M01_AXIS]

  # Create port connections
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins pl_rf_512] [get_bd_pins cmpy_0/aclk] [get_bd_pins cmpy_1/aclk] [get_bd_pins cmpy_2/aclk] [get_bd_pins cmpy_3/aclk] [get_bd_pins cmpy_4/aclk] [get_bd_pins cmpy_5/aclk] [get_bd_pins cmpy_6/aclk] [get_bd_pins cmpy_7/aclk] [get_bd_pins dac_i_upconverted/aclk] [get_bd_pins dac_iq_0/aclk] [get_bd_pins dac_iq_1/aclk] [get_bd_pins dac_iq_2/aclk] [get_bd_pins dac_iq_3/aclk] [get_bd_pins dac_iq_4/aclk] [get_bd_pins dac_iq_5/aclk] [get_bd_pins dac_iq_6/aclk] [get_bd_pins dac_iq_7/aclk] [get_bd_pins dac_q_upconverted/aclk] [get_bd_pins split_dac_i/aclk] [get_bd_pins split_dac_q/aclk] [get_bd_pins split_dds_iq/aclk] [get_bd_pins split_iq_0/aclk] [get_bd_pins split_iq_1/aclk] [get_bd_pins split_iq_2/aclk] [get_bd_pins split_iq_3/aclk] [get_bd_pins split_iq_4/aclk] [get_bd_pins split_iq_5/aclk] [get_bd_pins split_iq_6/aclk] [get_bd_pins split_iq_7/aclk]
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins m_axis_aresetn] [get_bd_pins dac_i_upconverted/aresetn] [get_bd_pins dac_iq_0/aresetn] [get_bd_pins dac_iq_1/aresetn] [get_bd_pins dac_iq_2/aresetn] [get_bd_pins dac_iq_3/aresetn] [get_bd_pins dac_iq_4/aresetn] [get_bd_pins dac_iq_5/aresetn] [get_bd_pins dac_iq_6/aresetn] [get_bd_pins dac_iq_7/aresetn] [get_bd_pins dac_q_upconverted/aresetn] [get_bd_pins split_dac_i/aresetn] [get_bd_pins split_dac_q/aresetn] [get_bd_pins split_dds_iq/aresetn] [get_bd_pins split_iq_0/aresetn] [get_bd_pins split_iq_1/aresetn] [get_bd_pins split_iq_2/aresetn] [get_bd_pins split_iq_3/aresetn] [get_bd_pins split_iq_4/aresetn] [get_bd_pins split_iq_5/aresetn] [get_bd_pins split_iq_6/aresetn] [get_bd_pins split_iq_7/aresetn]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: adc_downconversion
proc create_hier_cell_adc_downconversion { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_adc_downconversion() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 ADC_I_in

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ADC_I_out

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 ADC_Q_in

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 ADC_Q_out
  ...
  # Create instance: adc_i_downconverted, and set properties
  set adc_i_downconverted [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_i_downconverted ]
  set_property -dict [ list \
   CONFIG.NUM_SI {8} \
 ] $adc_i_downconverted

  # Create instance: adc_iq_0, and set properties
  set adc_iq_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_0 ]

  # Create instance: adc_iq_1, and set properties
  set adc_iq_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_1 ]

  # Create instance: adc_iq_2, and set properties
  set adc_iq_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_2 ]

  # Create instance: adc_iq_3, and set properties
  set adc_iq_3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_3 ]

  # Create instance: adc_iq_4, and set properties
  set adc_iq_4 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_4 ]

  # Create instance: adc_iq_5, and set properties
  set adc_iq_5 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_5 ]

  # Create instance: adc_iq_6, and set properties
  set adc_iq_6 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_6 ]

  # Create instance: adc_iq_7, and set properties
  set adc_iq_7 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_iq_7 ]

  # Create instance: adc_q_downconverted, and set properties
  set adc_q_downconverted [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_combiner:1.1 adc_q_downconverted ]
  set_property -dict [ list \
   CONFIG.NUM_SI {8} \
 ] $adc_q_downconverted
  ...
  # Create instance: split_adc_i, and set properties
  set split_adc_i [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_adc_i ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create instance: split_adc_q, and set properties
  set split_adc_q [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 split_adc_q ]
  set_property -dict [ list \
   CONFIG.HAS_TREADY {0} \
   CONFIG.M00_TDATA_REMAP {tdata[15:0]} \
   CONFIG.M01_TDATA_REMAP {tdata[31:16]} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins ADC_I_in] [get_bd_intf_pins split_adc_i/S_AXIS]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins ADC_Q_in] [get_bd_intf_pins split_adc_q/S_AXIS]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins ADC_Q_out] [get_bd_intf_pins adc_q_downconverted/M_AXIS]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins ADC_I_out] [get_bd_intf_pins adc_i_downconverted/M_AXIS]
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins DDS] [get_bd_intf_pins split_dds_iq/S_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S00_AXIS] [get_bd_intf_pins split_iq_0/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_10_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S07_AXIS] [get_bd_intf_pins split_iq_7/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M00_AXIS [get_bd_intf_pins cmpy_0/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M01_AXIS [get_bd_intf_pins cmpy_1/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M01_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M02_AXIS [get_bd_intf_pins cmpy_2/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M02_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M03_AXIS [get_bd_intf_pins cmpy_3/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M03_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_1_M06_AXIS [get_bd_intf_pins cmpy_6/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M06_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_1_M07_AXIS [get_bd_intf_pins cmpy_7/S_AXIS_B] [get_bd_intf_pins split_dds_iq/M07_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M00_AXIS [get_bd_intf_pins adc_iq_0/S00_AXIS] [get_bd_intf_pins split_adc_i/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M01_AXIS [get_bd_intf_pins adc_iq_1/S00_AXIS] [get_bd_intf_pins split_adc_i/M01_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M02_AXIS [get_bd_intf_pins adc_iq_2/S00_AXIS] [get_bd_intf_pins split_adc_i/M02_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M03_AXIS [get_bd_intf_pins adc_iq_3/S00_AXIS] [get_bd_intf_pins split_adc_i/M03_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M04_AXIS [get_bd_intf_pins adc_iq_4/S00_AXIS] [get_bd_intf_pins split_adc_i/M04_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M05_AXIS [get_bd_intf_pins adc_iq_5/S00_AXIS] [get_bd_intf_pins split_adc_i/M05_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M06_AXIS [get_bd_intf_pins adc_iq_6/S00_AXIS] [get_bd_intf_pins split_adc_i/M06_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_2_M07_AXIS [get_bd_intf_pins adc_iq_7/S00_AXIS] [get_bd_intf_pins split_adc_i/M07_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M00_AXIS [get_bd_intf_pins adc_iq_0/S01_AXIS] [get_bd_intf_pins split_adc_q/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M01_AXIS [get_bd_intf_pins adc_iq_1/S01_AXIS] [get_bd_intf_pins split_adc_q/M01_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M02_AXIS [get_bd_intf_pins adc_iq_2/S01_AXIS] [get_bd_intf_pins split_adc_q/M02_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M03_AXIS [get_bd_intf_pins adc_iq_3/S01_AXIS] [get_bd_intf_pins split_adc_q/M03_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M04_AXIS [get_bd_intf_pins adc_iq_4/S01_AXIS] [get_bd_intf_pins split_adc_q/M04_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M05_AXIS [get_bd_intf_pins adc_iq_5/S01_AXIS] [get_bd_intf_pins split_adc_q/M05_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M06_AXIS [get_bd_intf_pins adc_iq_6/S01_AXIS] [get_bd_intf_pins split_adc_q/M06_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_3_M07_AXIS [get_bd_intf_pins adc_iq_7/S01_AXIS] [get_bd_intf_pins split_adc_q/M07_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_4_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S01_AXIS] [get_bd_intf_pins split_iq_1/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_5_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S02_AXIS] [get_bd_intf_pins split_iq_2/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_6_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S03_AXIS] [get_bd_intf_pins split_iq_3/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_7_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S04_AXIS] [get_bd_intf_pins split_iq_4/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_8_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S05_AXIS] [get_bd_intf_pins split_iq_5/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_9_M00_AXIS [get_bd_intf_pins adc_i_downconverted/S06_AXIS] [get_bd_intf_pins split_iq_6/M00_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_0_M_AXIS [get_bd_intf_pins adc_iq_0/M_AXIS] [get_bd_intf_pins cmpy_0/S_AXIS_A]
  connect_bd_intf_net -intf_net axis_combiner_1_M_AXIS [get_bd_intf_pins adc_iq_1/M_AXIS] [get_bd_intf_pins cmpy_1/S_AXIS_A]
  connect_bd_intf_net -intf_net axis_combiner_2_M_AXIS [get_bd_intf_pins adc_iq_2/M_AXIS] [get_bd_intf_pins cmpy_2/S_AXIS_A]
  connect_bd_intf_net -intf_net axis_combiner_3_M_AXIS [get_bd_intf_pins adc_iq_3/M_AXIS] [get_bd_intf_pins cmpy_3/S_AXIS_A]
  connect_bd_intf_net -intf_net axis_combiner_4_M_AXIS [get_bd_intf_pins adc_iq_4/M_AXIS] [get_bd_intf_pins cmpy_4/S_AXIS_A]
  connect_bd_intf_net -intf_net axis_combiner_5_M_AXIS [get_bd_intf_pins adc_iq_5/M_AXIS] [get_bd_intf_pins cmpy_5/S_AXIS_A]
  connect_bd_intf_net -intf_net axis_combiner_6_M_AXIS [get_bd_intf_pins adc_iq_6/M_AXIS] [get_bd_intf_pins cmpy_6/S_AXIS_A]
  connect_bd_intf_net -intf_net axis_combiner_7_M_AXIS [get_bd_intf_pins adc_iq_7/M_AXIS] [get_bd_intf_pins cmpy_7/S_AXIS_A]
  connect_bd_intf_net -intf_net cmpy_0_M_AXIS_DOUT [get_bd_intf_pins cmpy_0/M_AXIS_DOUT] [get_bd_intf_pins split_iq_0/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_1_M_AXIS_DOUT [get_bd_intf_pins cmpy_1/M_AXIS_DOUT] [get_bd_intf_pins split_iq_1/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_2_M_AXIS_DOUT [get_bd_intf_pins cmpy_2/M_AXIS_DOUT] [get_bd_intf_pins split_iq_2/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_3_M_AXIS_DOUT [get_bd_intf_pins cmpy_3/M_AXIS_DOUT] [get_bd_intf_pins split_iq_3/S_AXIS]
  ...
  connect_bd_intf_net -intf_net cmpy_6_M_AXIS_DOUT [get_bd_intf_pins cmpy_6/M_AXIS_DOUT] [get_bd_intf_pins split_iq_6/S_AXIS]
  connect_bd_intf_net -intf_net cmpy_7_M_AXIS_DOUT [get_bd_intf_pins cmpy_7/M_AXIS_DOUT] [get_bd_intf_pins split_iq_7/S_AXIS]
  connect_bd_intf_net -intf_net split_iq_0_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S00_AXIS] [get_bd_intf_pins split_iq_0/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_1_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S01_AXIS] [get_bd_intf_pins split_iq_1/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_2_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S02_AXIS] [get_bd_intf_pins split_iq_2/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_3_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S03_AXIS] [get_bd_intf_pins split_iq_3/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_4_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S04_AXIS] [get_bd_intf_pins split_iq_4/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_5_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S05_AXIS] [get_bd_intf_pins split_iq_5/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_6_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S06_AXIS] [get_bd_intf_pins split_iq_6/M01_AXIS]
  connect_bd_intf_net -intf_net split_iq_7_M01_AXIS [get_bd_intf_pins adc_q_downconverted/S07_AXIS] [get_bd_intf_pins split_iq_7/M01_AXIS]

  # Create port connections
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins pl_rf_512] [get_bd_pins adc_i_downconverted/aclk] [get_bd_pins adc_iq_0/aclk] [get_bd_pins adc_iq_1/aclk] [get_bd_pins adc_iq_2/aclk] [get_bd_pins adc_iq_3/aclk] [get_bd_pins adc_iq_4/aclk] [get_bd_pins adc_iq_5/aclk] [get_bd_pins adc_iq_6/aclk] [get_bd_pins adc_iq_7/aclk] [get_bd_pins adc_q_downconverted/aclk] [get_bd_pins cmpy_0/aclk] [get_bd_pins cmpy_1/aclk] [get_bd_pins cmpy_2/aclk] [get_bd_pins cmpy_3/aclk] [get_bd_pins cmpy_4/aclk] [get_bd_pins cmpy_5/aclk] [get_bd_pins cmpy_6/aclk] [get_bd_pins cmpy_7/aclk] [get_bd_pins split_adc_i/aclk] [get_bd_pins split_adc_q/aclk] [get_bd_pins split_dds_iq/aclk] [get_bd_pins split_iq_0/aclk] [get_bd_pins split_iq_1/aclk] [get_bd_pins split_iq_2/aclk] [get_bd_pins split_iq_3/aclk] [get_bd_pins split_iq_4/aclk] [get_bd_pins split_iq_5/aclk] [get_bd_pins split_iq_6/aclk] [get_bd_pins split_iq_7/aclk]
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins m_axis_aresetn] [get_bd_pins adc_i_downconverted/aresetn] [get_bd_pins adc_iq_0/aresetn] [get_bd_pins adc_iq_1/aresetn] [get_bd_pins adc_iq_2/aresetn] [get_bd_pins adc_iq_3/aresetn] [get_bd_pins adc_iq_4/aresetn] [get_bd_pins adc_iq_5/aresetn] [get_bd_pins adc_iq_6/aresetn] [get_bd_pins adc_iq_7/aresetn] [get_bd_pins adc_q_downconverted/aresetn] [get_bd_pins split_adc_i/aresetn] [get_bd_pins split_adc_q/aresetn] [get_bd_pins split_dds_iq/aresetn] [get_bd_pins split_iq_0/aresetn] [get_bd_pins split_iq_1/aresetn] [get_bd_pins split_iq_2/aresetn] [get_bd_pins split_iq_3/aresetn] [get_bd_pins split_iq_4/aresetn] [get_bd_pins split_iq_5/aresetn] [get_bd_pins split_iq_6/aresetn] [get_bd_pins split_iq_7/aresetn]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: PL_DDS
proc create_hier_cell_PL_DDS { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PL_DDS() - Empty argument(s)!"}
     return
  }
  ...
  # Create interface pins
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 DDS
  ...
  # Create pins
  create_bd_pin -dir I -type rst ap_rst_n
  create_bd_pin -dir O -type intr event_pinc_invalid
  create_bd_pin -dir O -type intr event_poff_invalid
  create_bd_pin -dir I -type rst m_axis_aresetn
  create_bd_pin -dir I -type clk pl_rf_128
  create_bd_pin -dir I -type clk pl_rf_512
  ...
  set_property -dict [ list \
   ...
   CONFIG.DDS_Clock_Rate {128} \
   CONFIG.Frequency_Resolution {7812} \
   CONFIG.Has_Phase_Out {false} \
   CONFIG.Latency {10} \
   CONFIG.M_DATA_Has_TUSER {Not_Required} \
   CONFIG.Mode_of_Operation {Rasterized} \
   CONFIG.Modulus {16384} \
   ...
   CONFIG.Phase_Width {14} \
   CONFIG.Phase_offset {Fixed} \
   CONFIG.S_PHASE_Has_TUSER {Not_Required} \
 ] $dds_compiler_0

  # Create instance: dds_pinc_1, and set properties
  set dds_pinc_1 [ create_bd_cell -type ip -vlnv slaclab:hls:dds_pinc:1.0 dds_pinc_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Clock_Frequency {300.0} \
   CONFIG.CoefficientSource {COE_File} \
   CONFIG.Coefficient_File {../../../../../../../../data/pl_sweep_interpolating_filter/interpolating_filter.coe} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_periph256_M01_AXI [get_bd_intf_pins s_axi_control] [get_bd_intf_pins dds_pinc_1/s_axi_control]
  connect_bd_intf_net -intf_net axis_clock_converter_0_M_AXIS [get_bd_intf_pins axis_clock_converter_0/M_AXIS] [get_bd_intf_pins fir_compiler_0/S_AXIS_DATA]
  connect_bd_intf_net -intf_net dds_compiler_0_M_AXIS_DATA [get_bd_intf_pins axis_clock_converter_0/S_AXIS] [get_bd_intf_pins dds_compiler_0/M_AXIS_DATA]
  connect_bd_intf_net -intf_net dds_pinc_1_pinc_out [get_bd_intf_pins dds_compiler_0/S_AXIS_CONFIG] [get_bd_intf_pins dds_pinc_1/pinc_out]
  connect_bd_intf_net -intf_net fir_compiler_0_M_AXIS_DATA [get_bd_intf_pins DDS] [get_bd_intf_pins fir_compiler_0/M_AXIS_DATA]

  # Create port connections
  connect_bd_net -net Clocktree_dout [get_bd_pins ap_rst_n] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins dds_pinc_1/ap_rst_n]
  connect_bd_net -net Clocktree_pl_rf_128 [get_bd_pins pl_rf_128] [get_bd_pins axis_clock_converter_0/s_axis_aclk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dds_pinc_1/ap_clk]
  connect_bd_net -net dds_compiler_0_event_pinc_invalid [get_bd_pins event_pinc_invalid] [get_bd_pins dds_compiler_0/event_pinc_invalid]
  connect_bd_net -net dds_compiler_0_event_poff_invalid [get_bd_pins event_poff_invalid] [get_bd_pins dds_compiler_0/event_poff_invalid]
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins pl_rf_512] [get_bd_pins axis_clock_converter_0/m_axis_aclk] [get_bd_pins fir_compiler_0/aclk]
...
# Hierarchical cell: freq_sweep
proc create_hier_cell_freq_sweep { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_freq_sweep() - Empty argument(s)!"}
     return
  }
  ...
  # Create instance: PL_DDS
  create_hier_cell_PL_DDS $hier_obj PL_DDS

  # Create instance: adc_downconversion
  create_hier_cell_adc_downconversion $hier_obj adc_downconversion
  ...
  # Create instance: dac_upconversion
  create_hier_cell_dac_upconversion $hier_obj dac_upconversion

  # Create instance: stream_sign_flip_0, and set properties
  set stream_sign_flip_0 [ create_bd_cell -type ip -vlnv slaclab:hls:stream_sign_flip:1.0 stream_sign_flip_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins DAC_I_in] [get_bd_intf_pins dac_upconversion/DAC_I_in]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins DAC_Q_in] [get_bd_intf_pins dac_upconversion/DAC_Q_in]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins DAC_Q_out] [get_bd_intf_pins dac_upconversion/DAC_Q_out]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins DAC_I_out] [get_bd_intf_pins dac_upconversion/DAC_I_out]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins ADC_I_in] [get_bd_intf_pins adc_downconversion/ADC_I_in]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins ADC_I_out] [get_bd_intf_pins adc_downconversion/ADC_I_out]
  connect_bd_intf_net -intf_net Conn7 [get_bd_intf_pins ADC_Q_in] [get_bd_intf_pins adc_downconversion/ADC_Q_in]
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins ADC_Q_out] [get_bd_intf_pins adc_downconversion/ADC_Q_out]
  connect_bd_intf_net -intf_net PL_DDS_DDS [get_bd_intf_pins PL_DDS/DDS] [get_bd_intf_pins axis_broadcaster_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_periph256_M01_AXI [get_bd_intf_pins s_axi_control] [get_bd_intf_pins PL_DDS/s_axi_control]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins dac_upconversion/DDS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster_0/M01_AXIS] [get_bd_intf_pins stream_sign_flip_0/stream_in]
  connect_bd_intf_net -intf_net stream_sign_flip_0_stream_out [get_bd_intf_pins adc_downconversion/DDS] [get_bd_intf_pins stream_sign_flip_0/stream_out]

  # Create port connections
  connect_bd_net -net Clocktree_dout [get_bd_pins ap_rst_n] [get_bd_pins PL_DDS/ap_rst_n]
  connect_bd_net -net Clocktree_pl_rf_128 [get_bd_pins pl_rf_128] [get_bd_pins PL_DDS/pl_rf_128]
  connect_bd_net -net dds_compiler_0_event_pinc_invalid [get_bd_pins event_pinc_invalid] [get_bd_pins PL_DDS/event_pinc_invalid]
  connect_bd_net -net dds_compiler_0_event_poff_invalid [get_bd_pins event_poff_invalid] [get_bd_pins PL_DDS/event_poff_invalid]
  connect_bd_net -net m_axis_aclk_1 [get_bd_pins pl_rf_512] [get_bd_pins PL_DDS/pl_rf_512] [get_bd_pins adc_downconversion/pl_rf_512] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins dac_upconversion/pl_rf_512] [get_bd_pins stream_sign_flip_0/ap_clk]
  connect_bd_net -net m_axis_aresetn_1 [get_bd_pins m_axis_aresetn] [get_bd_pins PL_DDS/m_axis_aresetn] [get_bd_pins adc_downconversion/m_axis_aresetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins dac_upconversion/m_axis_aresetn] [get_bd_pins stream_sign_flip_0/ap_rst_n]
...
proc create_hier_cell_Clocktree { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 RF_128_NEVERARESETN
  ...
  create_bd_pin -dir O -type clk pl_rf_128
  create_bd_pin -dir I -type clk s_axi_aclk
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT3_PORT {pl_rf_128} \
  ...
  connect_bd_net -net RF_CLKGEN_pl_rf_128 [get_bd_pins pl_rf_128] [get_bd_pins RF_CLKGEN/pl_rf_128]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins RF_128_NEVERARESETN] [get_bd_pins xlconstant_2/dout]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: freq_sweep
  create_hier_cell_freq_sweep [current_bd_instance .] freq_sweep
...
Port;FD4A0000;FD4AFFFF;1|FPD;DPDMA;FD4C0000;FD4CFFFF;1|FPD;DDR_XMPU5_CFG;FD050000;FD05FFFF;1|FPD;DDR_XMPU4_CFG;FD040000;FD04FFFF;1|FPD;DDR_XMPU3_CFG;FD030000;FD03FFFF;1|FPD;DDR_XMPU2_CFG;FD020000;FD02FFFF;1|FPD;DDR_XMPU1_CFG;FD010000;FD01FFFF;1|FPD;DDR_XMPU0_CFG;FD000000;FD00FFFF;1|FPD;DDR_QOS_CTRL;FD090000;FD09FFFF;1|FPD;DDR_PHY;FD080000;FD08FFFF;1|DDR;DDR_LOW;0;7FFFFFFF;1|DDR;DDR_HIGH;800000000;87FFFFFFF;1|FPD;DDDR_CTRL;FD070000;FD070FFF;1|LPD;Coresight;FE800000;FEFFFFFF;1|LPD;CSU_DMA;FFC80000;FFC9FFFF;1|LPD;CSU;FFCA0000;FFCAFFFF;1|LPD;CRL_APB;FF5E0000;FF85FFFF;1|FPD;CRF_APB;FD1A0000;FD2DFFFF;1|FPD;CCI_REG;FD5E0000;FD5EFFFF;1|LPD;CAN1;FF070000;FF07FFFF;0|LPD;CAN0;FF060000;FF06FFFF;0|FPD;APU;FD5C0000;FD5CFFFF;1|LPD;APM_INTC_IOU;FFA20000;FFA2FFFF;1|LPD;APM_FPD_LPD;FFA30000;FFA3FFFF;1|FPD;APM_5;FD490000;FD49FFFF;1|FPD;APM_0;FD0B0000;FD0BFFFF;1|LPD;APM2;FFA10000;FFA1FFFF;1|LPD;APM1;FFA00000;FFA0FFFF;1|LPD;AMS;FFA50000;FFA5FFFF;1|FPD;AFI_5;FD3B0000;FD3BFFFF;1|FPD;AFI_4;FD3A0000;FD3AFFFF;1|FPD;AFI_3;FD390000;FD39FFFF;1|FPD;AFI_2;FD380000;FD38FFFF;1|FPD;AFI_1;FD370000;FD37FFFF;1|FPD;AFI_0;FD360000;FD36FFFF;1|LPD;AFIFM6;FF9B0000;FF9BFFFF;1|FPD;ACPU_GIC;F9010000;F907FFFF;1} \
  ...
  connect_bd_intf_net -intf_net axi_periph256_M01_AXI [get_bd_intf_pins axi_periph256/M01_AXI] [get_bd_intf_pins freq_sweep/s_axi_control]
  ...
  connect_bd_intf_net -intf_net axis_register_slice_2_M_AXIS [get_bd_intf_pins axis_register_slice_2/M_AXIS] [get_bd_intf_pins freq_sweep/DAC_I_in]
  connect_bd_intf_net -intf_net axis_register_slice_3_M_AXIS [get_bd_intf_pins axis_register_slice_3/M_AXIS] [get_bd_intf_pins freq_sweep/DAC_Q_in]
  connect_bd_intf_net -intf_net axis_register_slice_4_M_AXIS [get_bd_intf_pins axis_register_slice_4/M_AXIS] [get_bd_intf_pins freq_sweep/ADC_I_in]
  connect_bd_intf_net -intf_net axis_register_slice_5_M_AXIS [get_bd_intf_pins axis_broadcaster_0/S_AXIS] [get_bd_intf_pins axis_register_slice_5/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_6_M_AXIS [get_bd_intf_pins axis_broadcaster_1/S_AXIS] [get_bd_intf_pins axis_register_slice_6/M_AXIS]
  connect_bd_intf_net -intf_net axis_register_slice_7_M_AXIS [get_bd_intf_pins axis_register_slice_7/M_AXIS] [get_bd_intf_pins freq_sweep/ADC_Q_in]
  ...
  connect_bd_intf_net -intf_net dactable_iout [get_bd_intf_pins axis_register_slice_2/S_AXIS] [get_bd_intf_pins dactable/iout]
  connect_bd_intf_net -intf_net dactable_qout [get_bd_intf_pins axis_register_slice_3/S_AXIS] [get_bd_intf_pins dactable/qout]
  connect_bd_intf_net -intf_net freq_sweep_ADC_I_out [get_bd_intf_pins axis_register_slice_5/S_AXIS] [get_bd_intf_pins freq_sweep/ADC_I_out]
  connect_bd_intf_net -intf_net freq_sweep_ADC_Q_out [get_bd_intf_pins axis_register_slice_6/S_AXIS] [get_bd_intf_pins freq_sweep/ADC_Q_out]
  connect_bd_intf_net -intf_net freq_sweep_DAC_I_out [get_bd_intf_pins axis_register_slice_0/S_AXIS] [get_bd_intf_pins freq_sweep/DAC_I_out]
  connect_bd_intf_net -intf_net freq_sweep_DAC_Q_out [get_bd_intf_pins axis_register_slice_1/S_AXIS] [get_bd_intf_pins freq_sweep/DAC_Q_out]
  ...
  connect_bd_intf_net -intf_net rfdc_i_axis [get_bd_intf_pins axis_register_slice_4/S_AXIS] [get_bd_intf_pins rfdc/i_axis]
  connect_bd_intf_net -intf_net rfdc_q_axis [get_bd_intf_pins axis_register_slice_7/S_AXIS] [get_bd_intf_pins rfdc/q_axis]
  ...
  connect_bd_net -net Clocktree_dout [get_bd_pins Clocktree/RF_128_NEVERARESETN] [get_bd_pins axi_periph256/M01_ARESETN] [get_bd_pins freq_sweep/ap_rst_n]
  connect_bd_net -net Clocktree_interrupt [get_bd_pins Clocktree/mmcm_interrupt] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net Clocktree_pl_rf_128 [get_bd_pins Clocktree/pl_rf_128] [get_bd_pins axi_periph256/M01_ACLK] [get_bd_pins freq_sweep/pl_rf_128]
  ...
  connect_bd_net -net Net [get_bd_pins Clocktree/RF_512_NEVERARESETN] [get_bd_pins axi_periph512/M00_ARESETN] [get_bd_pins axi_periph512/M01_ARESETN] [get_bd_pins axi_periph512/M02_ARESETN] [get_bd_pins axi_periph512/M03_ARESETN] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_broadcaster_1/aresetn] [get_bd_pins axis_register_slice_4/aresetn] [get_bd_pins axis_register_slice_5/aresetn] [get_bd_pins axis_register_slice_6/aresetn] [get_bd_pins axis_register_slice_7/aresetn] [get_bd_pins capture/pipe_aresetn] [get_bd_pins dactable/ap_rst_n] [get_bd_pins freq_sweep/m_axis_aresetn] [get_bd_pins photon_pipe/ap_rst_n]
  connect_bd_net -net RF_256_ARESETN [get_bd_pins Clocktree/RF_256_ARESETN] [get_bd_pins axi_periph256/ARESETN] [get_bd_pins axi_periph256/M00_ARESETN] [get_bd_pins axi_periph256/M03_ARESETN] [get_bd_pins capture/s_axi_aresetn] [get_bd_pins leds/In4] [get_bd_pins pps_synchronization/ap_rst_n]
  connect_bd_net -net RF_256_CLK [get_bd_pins Clocktree/RF_256_CLK] [get_bd_pins axi_periph256/ACLK] [get_bd_pins axi_periph256/M00_ACLK] [get_bd_pins axi_periph256/M02_ACLK] [get_bd_pins axi_periph256/M03_ACLK] [get_bd_pins capture/axis2mm_clk] [get_bd_pins leds/clk2] [get_bd_pins pps_synchronization/ap_clk] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  connect_bd_net -net RF_512_ARESETN [get_bd_pins Clocktree/RF_512_ARESETN] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_periph512/ARESETN] [get_bd_pins axi_periph512/M04_ARESETN] [get_bd_pins axi_periph512/M05_ARESETN] [get_bd_pins axi_periph512/M06_ARESETN] [get_bd_pins axis_register_slice_0/aresetn] [get_bd_pins axis_register_slice_1/aresetn] [get_bd_pins axis_register_slice_2/aresetn] [get_bd_pins axis_register_slice_3/aresetn] [get_bd_pins capture/s_axis_aresetn] [get_bd_pins leds/In3] [get_bd_pins rfdc/RF_512_ARESETN]
  connect_bd_net -net RF_512_CLK [get_bd_pins Clocktree/RF_512_CLK] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_periph512/ACLK] [get_bd_pins axi_periph512/M00_ACLK] [get_bd_pins axi_periph512/M01_ACLK] [get_bd_pins axi_periph512/M02_ACLK] [get_bd_pins axi_periph512/M03_ACLK] [get_bd_pins axi_periph512/M04_ACLK] [get_bd_pins axi_periph512/M05_ACLK] [get_bd_pins axi_periph512/M06_ACLK] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_broadcaster_1/aclk] [get_bd_pins axis_register_slice_0/aclk] [get_bd_pins axis_register_slice_1/aclk] [get_bd_pins axis_register_slice_2/aclk] [get_bd_pins axis_register_slice_3/aclk] [get_bd_pins axis_register_slice_4/aclk] [get_bd_pins axis_register_slice_5/aclk] [get_bd_pins axis_register_slice_6/aclk] [get_bd_pins axis_register_slice_7/aclk] [get_bd_pins capture/pipe_clk] [get_bd_pins dactable/ap_clk] [get_bd_pins freq_sweep/pl_rf_512] [get_bd_pins leds/clk] [get_bd_pins photon_pipe/aclk] [get_bd_pins rfdc/RF_512_CLK]
  ...
  connect_bd_net -net freq_sweep_event_pinc_invalid [get_bd_pins freq_sweep/event_pinc_invalid] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net freq_sweep_event_poff_invalid [get_bd_pins freq_sweep/event_poff_invalid] [get_bd_pins xlconcat_0/In3]
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs freq_sweep/PL_DDS/dds_pinc_1/s_axi_control/Reg] -force
