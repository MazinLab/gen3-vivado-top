...
class CuberTest(unittest.TestCase):
    def test_cuber(self):
        ...
        async def testbench(ctx):
            ...
            self.assertEqual(ctx.get(dut.cuber.mem1.data[0b00100110111]), 0)
            ...
            await ctx.tick().repeat(1500)
            self.assertEqual(ctx.get(dut.cuber.mem2.data[0b00100111001]), 0b00000001_00000000_00000000_00000001_00000000)
            await ctx.tick()
